...
// internal sealed class emrals_FuseElementsElement_Height_Property :235
// {
static void emrals_FuseElementsElement_Height_Property_build(uType* type)
{
    ...
    type->SetFields(1,
        ::TYPES[0/*Fuse.Elements.Element*/], offsetof(emrals_FuseElementsElement_Height_Property, _obj), uFieldFlagsWeak);
}
...
// public emrals_FuseElementsElement_Height_Property(Fuse.Elements.Element obj, Uno.UX.Selector name) :238
...
// public override sealed Uno.UX.Size Get(Uno.UX.PropertyObject obj) :240
...
// public emrals_FuseElementsElement_Height_Property New(Fuse.Elements.Element obj, Uno.UX.Selector name) :238
...
// public override sealed void Set(Uno.UX.PropertyObject obj, Uno.UX.Size v, Uno.UX.IPropertyListener origin) :241
...
// public emrals_FuseElementsElement_Height_Property(Fuse.Elements.Element obj, Uno.UX.Selector name) [instance] :238
...
// public emrals_FuseElementsElement_Height_Property New(Fuse.Elements.Element obj, Uno.UX.Selector name) [static] :238
