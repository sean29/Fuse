...
struct MyLoadingIndicator2 : ::g::Fuse::Controls::Panel
{
    ...
    static uSStrong<uArray*>& __g_static_nametable1() { return MyLoadingIndicator2_typeof()->Init(), __g_static_nametable1_; }
    ...
    static ::g::Uno::UX::Selector& __selector4() { return MyLoadingIndicator2_typeof()->Init(), __selector4_; }
