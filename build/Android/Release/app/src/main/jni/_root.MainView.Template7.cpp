...
{
    MainView__Template7::__selector0_ = ::g::Uno::UX::Selector__op_Implicit(::STRINGS[0/*"impact"*/]);
}

static void MainView__Template7_build(uType* type)
{
    ::STRINGS[0] = uString::Const("impact");
    type->SetFields(2,
...
{
    ::g::ImpactPage* __self1 = ::g::ImpactPage::New5(uPtr(__this->__parent1)->router);
