...
{
    MainView__Template6::__selector0_ = ::g::Uno::UX::Selector__op_Implicit(::STRINGS[0/*"alertdetail"*/]);
}

static void MainView__Template6_build(uType* type)
{
    ::STRINGS[0] = uString::Const("alertdetail");
    type->SetFields(2,
...
{
    ::g::AlertDetailPage* __self1 = ::g::AlertDetailPage::New5(uPtr(__this->__parent1)->router);
...
{
    ctor_(::STRINGS[0/*"alertdetail"*/], false);
    __parent1 = parent;
