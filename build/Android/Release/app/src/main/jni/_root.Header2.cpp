// This file was generated based on '.uno/ux13/Header2.g.uno'.
...
// public partial sealed class Header2 :2
// {
// static Header2() :4
static void Header2__cctor_4_fn(uType* __type)
{
}

static void Header2_build(uType* type)
{
    type->SetInterfaces(
...
::g::Fuse::Controls::TextControl_type* Header2_typeof()
{
    ...
    options.ObjectSize = sizeof(Header2);
    options.TypeSize = sizeof(::g::Fuse::Controls::TextControl_type);
    type = (::g::Fuse::Controls::TextControl_type*)uClassType::New("Header2", options);
    type->fp_build_ = Header2_build;
    type->fp_ctor_ = (void*)Header2__New4_fn;
    type->fp_cctor_ = Header2__cctor_4_fn;
...
// public Header2() :8
void Header2__ctor_8_fn(Header2* __this)
{
    __this->ctor_8();
}

// private void InitializeUX() :12
void Header2__InitializeUX1_fn(Header2* __this)
{
    __this->InitializeUX1();
}

// public Header2 New() :8
void Header2__New4_fn(Header2** __retval)
{
    *__retval = Header2::New4();
}

// public Header2() [instance] :8
void Header2::ctor_8()
{
    ctor_7();
    InitializeUX1();
...
void Header2::InitializeUX1()
{
    ::g::Fuse::Font* temp = ::g::Fuse::Font::New2(::g::Uno::UX::BundleFileSource::New1(::g::emrals_bundle::AlegreyaSansBold311715f6()));
    TextWrapping(1);
    FontSize(22.0f);
...
// public Header2 New() [static] :8
Header2* Header2::New4()
{
    Header2* obj1 = (Header2*)uNew(Header2_typeof());
    obj1->ctor_8();
    return obj1;
}
// }
