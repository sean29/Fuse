...
{
    EcanThankYouPage::__g_static_nametable1_ = uArray::Init<uString*>(::TYPES[0/*string[]*/], 4, ::STRINGS[0/*"router"*/], ::STRINGS[1/*"temp_eb33"*/], ::STRINGS[2/*"temp_eb34"*/], ::STRINGS[3/*"temp_eb35"*/]);
...
static void EcanThankYouPage_build(uType* type)
{
    ...
    type->SetFields(111,
        ...
        ::g::Fuse::Reactive::EventBinding_typeof(), offsetof(::g::EcanThankYouPage, temp_eb33), 0,
        ::g::Fuse::Reactive::EventBinding_typeof(), offsetof(::g::EcanThankYouPage, temp_eb34), 0,
        ::g::Fuse::Reactive::EventBinding_typeof(), offsetof(::g::EcanThankYouPage, temp_eb35), 0,
...
void EcanThankYouPage::InitializeUX()
{
    ...
    temp_eb33 = ::g::Fuse::Reactive::EventBinding::New1((uObject*)temp5, __g_nametable1);
    ::g::Fuse::Controls::Image* temp20 = ::g::Fuse::Controls::Image::New3();
    temp_eb34 = ::g::Fuse::Reactive::EventBinding::New1((uObject*)temp6, __g_nametable1);
    ::g::Fuse::Controls::Image* temp21 = ::g::Fuse::Controls::Image::New3();
    temp_eb35 = ::g::Fuse::Reactive::EventBinding::New1((uObject*)temp7, __g_nametable1);
    temp8->LineNumber(3);
    temp8->FileName(::STRINGS[10/*"Pages/EcanT...*/]);
    temp8->File(::g::Uno::UX::BundleFileSource::New1(::g::emrals_bundle::EcanThankYouPage93cd645a()));
    ...
    temp10->File(::g::Uno::UX::BundleFileSource::New1(::g::emrals_bundle::emralsAllgreen2017logo99edd694()));
    ...
    temp17->Alignment(4);
    temp17->File(::g::Uno::UX::BundleFileSource::New1(::g::emrals_bundle::ECANnotesca913ebd()));
    ...
    ::g::Fuse::Gestures::Clicked::AddHandler(temp19, uDelegate::New(::TYPES[3/*Fuse.Gestures.ClickedHandler*/], (void*)::g::Fuse::Reactive::EventBinding__OnEvent_fn, uPtr(temp_eb33)));
    temp19->File(::g::Uno::UX::BundleFileSource::New1(::g::emrals_bundle::cameratag5415edcc()));
    ::g::Uno::Collections::ICollection::Add_ex(uInterface(uPtr(temp19->Bindings()), ::TYPES[2/*Uno.Collections.ICollection<Fuse.Binding>*/]), temp_eb33);
    temp20->Height(::g::Uno::UX::Size__New1(40.0f, 1));
    ::g::Fuse::Gestures::Clicked::AddHandler(temp20, uDelegate::New(::TYPES[3/*Fuse.Gestures.ClickedHandler*/], (void*)::g::Fuse::Reactive::EventBinding__OnEvent_fn, uPtr(temp_eb34)));
    temp20->File(::g::Uno::UX::BundleFileSource::New1(::g::emrals_bundle::buyicona8a87298()));
    ::g::Uno::Collections::ICollection::Add_ex(uInterface(uPtr(temp20->Bindings()), ::TYPES[2/*Uno.Collections.ICollection<Fuse.Binding>*/]), temp_eb34);
    temp21->Height(::g::Uno::UX::Size__New1(40.0f, 1));
    ::g::Fuse::Gestures::Clicked::AddHandler(temp21, uDelegate::New(::TYPES[3/*Fuse.Gestures.ClickedHandler*/], (void*)::g::Fuse::Reactive::EventBinding__OnEvent_fn, uPtr(temp_eb35)));
    temp21->File(::g::Uno::UX::BundleFileSource::New1(::g::emrals_bundle::v2ecansicon81d4c260()));
    ::g::Uno::Collections::ICollection::Add_ex(uInterface(uPtr(temp21->Bindings()), ::TYPES[2/*Uno.Collections.ICollection<Fuse.Binding>*/]), temp_eb35);
