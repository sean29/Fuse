...
static void FormUpload_build(uType* type)
{
    ...
    ::TYPES[6] = ::g::Uno::Collections::Dictionary__Enumerator_typeof()->MakeType(::g::Uno::String_typeof(), ::g::Uno::String_typeof(), NULL);
    ::TYPES[7] = ::g::Uno::Collections::KeyValuePair_typeof()->MakeType(::g::Uno::String_typeof(), ::g::Uno::String_typeof(), NULL);
...
// private static byte[] GetMultipartFormData(Uno.Collections.Dictionary<string, object> postParameters, string boundary) :159
...
// public static Uno.Net.Http.HttpMessageHandlerRequest MultipartFormDataPost(string postUrl, string postMethod, Uno.Collections.Dictionary<string, string> headers, Uno.Collections.Dictionary<string, object> postParameters, byte[]& formData) :113
...
// private static Uno.Net.Http.HttpMessageHandlerRequest PostForm(string postUrl, string postMethod, string contentType, Uno.Collections.Dictionary<string, string> headers, byte[] formData) :122
...
// private static byte[] GetMultipartFormData(Uno.Collections.Dictionary<string, object> postParameters, string boundary) [static] :159
...
// public static Uno.Net.Http.HttpMessageHandlerRequest MultipartFormDataPost(string postUrl, string postMethod, Uno.Collections.Dictionary<string, string> headers, Uno.Collections.Dictionary<string, object> postParameters, byte[]& formData) [static] :113
...
{
    FormUpload_typeof()->Init();
    uString* formDataBoundary = ::g::Uno::String::Format(::STRINGS[6/*"----------{...*/], uArray::Init<uObject*>(::TYPES[3/*object[]*/], 1, (uString*)::g::Uno::Long::ToString(uPtr(::g::Uno::DateTime::Now())->TickOfDay(), ::TYPES[5/*long*/])));
...
// private static Uno.Net.Http.HttpMessageHandlerRequest PostForm(string postUrl, string postMethod, string contentType, Uno.Collections.Dictionary<string, string> headers, byte[] formData) [static] :122
::g::Uno::Net::Http::HttpMessageHandlerRequest* FormUpload::PostForm(uString* postUrl, uString* postMethod, uString* contentType, ::g::Uno::Collections::Dictionary* headers, uArray* formData)
{
    ...
    for (::g::Uno::Collections::Dictionary__Enumerator<uStrong<uString*>, uStrong<uString*> > enum1 = (::g::Uno::Collections::Dictionary__GetEnumerator_fn(uPtr(headers), &ret6), ret6); enum1.MoveNext(::TYPES[6/*Uno.Collections.Dictionary<string, string>.Enumerator*/]); )
    {
        ::g::Uno::Collections::KeyValuePair<uStrong<uString*>, uStrong<uString*> > header = enum1.Current(::TYPES[6/*Uno.Collections.Dictionary<string, string>.Enumerator*/]);
        uPtr(request)->SetHeader(header.Key(::TYPES[7/*Uno.Collections.KeyValuePair<string, string>*/]), header.Value(::TYPES[7/*Uno.Collections.KeyValuePair<string, string>*/]));
    }

    uPtr(request)->SetHeader(::STRINGS[8/*"Content-Type"*/], contentType);
    request->SetHeader(::STRINGS[9/*"Content-Len...*/], ::g::Uno::Int::ToString(uPtr(formData)->Length(), ::TYPES[8/*int*/]));
    return request;
}
// }
