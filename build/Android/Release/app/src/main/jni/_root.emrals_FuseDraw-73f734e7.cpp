...
// internal sealed class emrals_FuseDrawingSolidColor_Color_Property :133
// {
static void emrals_FuseDrawingSolidColor_Color_Property_build(uType* type)
{
    ...
    type->SetFields(1,
        ::TYPES[0/*Fuse.Drawing.SolidColor*/], offsetof(::g::emrals_FuseDrawingSolidColor_Color_Property, _obj), uFieldFlagsWeak);
}
...
// public emrals_FuseDrawingSolidColor_Color_Property(Fuse.Drawing.SolidColor obj, Uno.UX.Selector name) :136
...
// public override sealed float4 Get(Uno.UX.PropertyObject obj) :138
...
// public emrals_FuseDrawingSolidColor_Color_Property New(Fuse.Drawing.SolidColor obj, Uno.UX.Selector name) :136
...
// public override sealed void Set(Uno.UX.PropertyObject obj, float4 v, Uno.UX.IPropertyListener origin) :139
...
// public override sealed bool get_SupportsOriginSetter() :140
...
// public emrals_FuseDrawingSolidColor_Color_Property(Fuse.Drawing.SolidColor obj, Uno.UX.Selector name) [instance] :136
...
// public emrals_FuseDrawingSolidColor_Color_Property New(Fuse.Drawing.SolidColor obj, Uno.UX.Selector name) [static] :136
