...
jint JNICALL callUno_QreaderImpl_RC_BARCODE_CAPTUREGet451(JNIEnv *env,jclass clazz)
{
    uAutoReleasePool pool;
    INIT_JNI;
    jint __jresult;
...
jobject JNICALL callUno_Neovisionaries_WebSocketClient__webSocketGet435(JNIEnv *env,jclass clazz,jobject jthis)
{
    uAutoReleasePool pool;
    INIT_JNI;
...
void JNICALL callUno_Neovisionaries_WebSocketClient__webSocketSet435(JNIEnv *env,jclass clazz,jobject jthis,jobject setVal,jlong setValPtr)
{
    uAutoReleasePool pool;
    INIT_JNI;
    ::g::Neovisionaries::WebSocketClient* uno_jthis = uCast<::g::Neovisionaries::WebSocketClient*>(::g::Uno::Compiler::ExportTargetInterop::Foreign::Android::JavaUnoObject::UnBox(jthis), ::g::Neovisionaries::WebSocketClient_typeof());
...
void JNICALL callUno_QreaderImpl_Cancelled453(JNIEnv *env,jclass clazz)
{
    uAutoReleasePool pool;
    INIT_JNI;
    JTRY
...
void JNICALL callUno_QreaderImpl_Picked452(JNIEnv *env,jclass clazz,jobject result)
{
    uAutoReleasePool pool;
    INIT_JNI;
...
void ExternBlockHost::RegisterFunctions()
{
    ...
    {(char* const)"callUno_Neovisionaries_WebSocketClient__webSocketGet435", (char* const)"(Lcom/uno/UnoObject;)Ljava/lang/Object;", (void *)&callUno_Neovisionaries_WebSocketClient__webSocketGet435},
    ...
    {(char* const)"callUno_Neovisionaries_WebSocketClient__webSocketSet435", (char* const)"(Lcom/uno/UnoObject;Ljava/lang/Object;J)V", (void *)&callUno_Neovisionaries_WebSocketClient__webSocketSet435},
    {(char* const)"callUno_QreaderImpl_RC_BARCODE_CAPTUREGet451", (char* const)"()I", (void *)&callUno_QreaderImpl_RC_BARCODE_CAPTUREGet451},
    {(char* const)"callUno_QreaderImpl_Picked452", (char* const)"(Ljava/lang/String;)V", (void *)&callUno_QreaderImpl_Picked452},
    {(char* const)"callUno_QreaderImpl_Cancelled453", (char* const)"()V", (void *)&callUno_QreaderImpl_Cancelled453},
    };
    int funcCount = 130;
