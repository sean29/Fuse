...
// internal sealed class emrals_FuseControlsImage_File_Property :185
// {
static void emrals_FuseControlsImage_File_Property_build(uType* type)
{
    ...
    type->SetFields(1,
        ::TYPES[0/*Fuse.Controls.Image*/], offsetof(emrals_FuseControlsImage_File_Property, _obj), uFieldFlagsWeak);
}
...
// public emrals_FuseControlsImage_File_Property(Fuse.Controls.Image obj, Uno.UX.Selector name) :188
...
// public override sealed Uno.UX.FileSource Get(Uno.UX.PropertyObject obj) :190
...
// public emrals_FuseControlsImage_File_Property New(Fuse.Controls.Image obj, Uno.UX.Selector name) :188
...
// public override sealed Uno.UX.PropertyObject get_Object() :189
...
// public override sealed void Set(Uno.UX.PropertyObject obj, Uno.UX.FileSource v, Uno.UX.IPropertyListener origin) :191
...
// public emrals_FuseControlsImage_File_Property(Fuse.Controls.Image obj, Uno.UX.Selector name) [instance] :188
...
// public emrals_FuseControlsImage_File_Property New(Fuse.Controls.Image obj, Uno.UX.Selector name) [static] :188
