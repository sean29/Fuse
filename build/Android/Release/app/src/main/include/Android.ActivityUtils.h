// This file was generated based on C:/Users/q/AppData/Local/Fusetools/Packages/Android.ActivityUtils/1.2.0/$.uno.
...
struct ActivityUtils : uObject
{
    ...
    static int _requestID_;
    static int& _requestID() { return ActivityUtils_typeof()->Init(), _requestID_; }
    ...
    static void StartForResultJava(int id, ::g::Java::Object* _intent);
