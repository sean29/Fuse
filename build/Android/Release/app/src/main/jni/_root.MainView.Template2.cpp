...
// {
// static Template2() :53
static void MainView__Template2__cctor_5_fn(uType* __type)
{
    ::g::Uno::UX::Selector_typeof()->Init();
    MainView__Template2::__selector01_ = ::g::Uno::UX::Selector__op_Implicit(uString::Const("alerts"));
}
...
static void MainView__Template2_build(uType* type)
{
    ...
    type->SetFields(137,
        ...
        ::g::Uno::UX::Selector_typeof(), (uintptr_t)&MainView__Template2::__selector01_, uFieldFlagsStatic);
}
...
::g::Fuse::Controls::Panel_type* MainView__Template2_typeof()
{
    ...
    options.BaseDefinition = ::g::AlertsPage_typeof();
    options.FieldCount = 139;
    options.InterfaceCount = 18;
    options.ObjectSize = sizeof(MainView__Template2);
    options.TypeSize = sizeof(::g::Fuse::Controls::Panel_type);
    type = (::g::Fuse::Controls::Panel_type*)uClassType::New("MainView.Template2", options);
    type->fp_build_ = MainView__Template2_build;
    type->fp_cctor_ = MainView__Template2__cctor_5_fn;
...
// public Template2(MainView parent, Fuse.Navigation.Router router) :58
...
// public Template2 New(MainView parent, Fuse.Navigation.Router router) :58
void MainView__Template2__New6_fn(::g::MainView* parent, ::g::Fuse::Navigation::Router* router1, MainView__Template2** __retval)
{
    *__retval = MainView__Template2::New6(parent, router1);
}

::g::Uno::UX::Selector MainView__Template2::__selector01_;

// public Template2(MainView parent, Fuse.Navigation.Router router) [instance] :58
void MainView__Template2::ctor_9(::g::MainView* parent, ::g::Fuse::Navigation::Router* router1)
{
    ctor_8(router1);
    __parent1 = parent;
    InitializeUX1();
...
void MainView__Template2::InitializeUX1()
{
    Name(MainView__Template2::__selector01_);
}

// public Template2 New(MainView parent, Fuse.Navigation.Router router) [static] :58
MainView__Template2* MainView__Template2::New6(::g::MainView* parent, ::g::Fuse::Navigation::Router* router1)
{
