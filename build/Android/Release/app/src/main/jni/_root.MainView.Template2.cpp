...
{
    MainView__Template2::__selector0_ = ::g::Uno::UX::Selector__op_Implicit(::STRINGS[0/*"ecans"*/]);
}

static void MainView__Template2_build(uType* type)
{
    ::STRINGS[0] = uString::Const("ecans");
    type->SetFields(2,
...
{
    ::g::EcansPage* __self1 = ::g::EcansPage::New5(uPtr(__this->__parent1)->router);
