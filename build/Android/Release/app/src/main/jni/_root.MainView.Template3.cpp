...
{
    MainView__Template3::__selector0_ = ::g::Uno::UX::Selector__op_Implicit(::STRINGS[0/*"camera"*/]);
}

static void MainView__Template3_build(uType* type)
{
    ::STRINGS[0] = uString::Const("camera");
    type->SetFields(2,
...
{
    ::g::CameraPage* __self1 = ::g::CameraPage::New5(uPtr(__this->__parent1)->router);
