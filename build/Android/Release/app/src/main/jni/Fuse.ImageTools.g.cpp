...
// C:\Users\q\AppData\Local\Fusetools\Packages\Fuse.ImageTools\1.3.0-rc2\Android\AndroidImageUtils.uno
// ---------------------------------------------------------------------------------------------------
...
{
    {
        ...
        WITH_STATIC_JAVA_METHOD(__mtd, __cls, "Crop373", "(Ljava/lang/String;IIIILcom/foreign/Uno/Action_String;Lcom/foreign/Uno/Action_String;Z)V");
        uString* _upath=path;
...
{
    {
        INIT_JNI;
        jclass __cls = JniHelper::GetNativeExternClass();
        WITH_STATIC_JAVA_METHOD(__mtd, __cls, "GetBase64FromImage374", "(Ljava/lang/String;Lcom/foreign/Uno/Action_String;Lcom/foreign/Uno/Action_String;)V");
        uString* _upath=path;
        jstring _path = JniHelper::UnoToJavaString(_upath);
        uDelegate* _uonSuccess=onSuccess;
        jobject _onSuccess = ::g::Uno::Compiler::ExportTargetInterop::Foreign::Android::JavaUnoObject::BoxDelegate((uObject*)_uonSuccess, "com.foreign.Uno.Action_String");
...
{
    {
        INIT_JNI;
        jclass __cls = JniHelper::GetNativeExternClass();
        WITH_STATIC_JAVA_METHOD(__mtd, __cls, "GetImageFromBase64375", "(Ljava/lang/String;Lcom/foreign/Uno/Action_String;Lcom/foreign/Uno/Action_String;)V");
        uString* _ub64=b64;
...
{
    {
        INIT_JNI;
        jclass __cls = JniHelper::GetNativeExternClass();
        WITH_STATIC_JAVA_METHOD(__mtd, __cls, "GetImageFromBuffer376", "(Lcom/uno/ByteArray;Lcom/foreign/Uno/Action_String;Lcom/foreign/Uno/Action_String;)V");
...
{
    {
        INIT_JNI;
        jclass __cls = JniHelper::GetNativeExternClass();
        WITH_STATIC_JAVA_METHOD(__mtd, __cls, "GetImageFromBufferSync377", "(Lcom/uno/ByteArray;)Ljava/lang/String;");
        uArray* _ubytes=bytes;
        jobject _bytes = ::g::Uno::Compiler::ExportTargetInterop::Foreign::Android::JavaUnoObject::Box8(_ubytes);
...
{
    {
        INIT_JNI;
        jclass __cls = JniHelper::GetNativeExternClass();
        WITH_STATIC_JAVA_METHOD(__mtd, __cls, "GetSizeInternal378", "(Ljava/lang/String;Lcom/uno/IntArray;)V");
        uString* _upath=path;
        jstring _path = JniHelper::UnoToJavaString(_upath);
...
{
    {
        INIT_JNI;
        jclass __cls = JniHelper::GetNativeExternClass();
        WITH_STATIC_JAVA_METHOD(__mtd, __cls, "Resize379", "(Ljava/lang/String;IIILcom/foreign/Uno/Action_String;Lcom/foreign/Uno/Action_String;Z)V");
        uString* _upath=path;
        jstring _path = JniHelper::UnoToJavaString(_upath);
        int _uwidth=width;
        jint _width = (jint)_uwidth;
...
// C:\Users\q\AppData\Local\Fusetools\Packages\Fuse.ImageTools\1.3.0-rc2\PromiseCallbacks.uno
// ------------------------------------------------------------------------------------------
...
// C:\Users\q\AppData\Local\Fusetools\Packages\Fuse.ImageTools\1.3.0-rc2\Android\Commands.uno
// ------------------------------------------------------------------------------------------
...
// C:\Users\q\AppData\Local\Fusetools\Packages\Fuse.ImageTools\1.3.0-rc2\ImageTools.uno
// ------------------------------------------------------------------------------------
...
// C:\Users\q\AppData\Local\Fusetools\Packages\Fuse.ImageTools\1.3.0-rc2\Image.uno
// -------------------------------------------------------------------------------
...
void ImageTools::ctor_2()
{
    ...
    AddMember((::g::Fuse::Scripting::NativeProperty__New3_fn(::g::Fuse::Scripting::NativeProperty_typeof()->MakeType(uObject_typeof(), ::g::Uno::Int_typeof(), NULL), uString::Const("IGNORE_ASPECT"), uCRef<int>(0), &ret2), ret2));
    AddMember((::g::Fuse::Scripting::NativeProperty__New3_fn(::g::Fuse::Scripting::NativeProperty_typeof()->MakeType(uObject_typeof(), ::g::Uno::Int_typeof(), NULL), uString::Const("KEEP_ASPECT"), uCRef<int>(1), &ret3), ret3));
    AddMember((::g::Fuse::Scripting::NativeProperty__New3_fn(::g::Fuse::Scripting::NativeProperty_typeof()->MakeType(uObject_typeof(), ::g::Uno::Int_typeof(), NULL), uString::Const("SCALE_AND_CROP"), uCRef<int>(2), &ret4), ret4));
}
...
::g::Uno::Threading::Future1* ImageTools::CropImageInterface(uArray* args)
{
    ...
    if (opts != NULL)
    {
        x = (::g::Fuse::Scripting::JSObjectUtils__ValueOrDefault_fn(::g::Fuse::Scripting::JSObjectUtils_typeof()->MakeMethod(0/*ValueOrDefault<int>*/, ::g::Uno::Int_typeof(), NULL), opts, uString::Const("x"), uCRef<int>(0), &ret5), ret5);
        y = (::g::Fuse::Scripting::JSObjectUtils__ValueOrDefault_fn(::g::Fuse::Scripting::JSObjectUtils_typeof()->MakeMethod(0/*ValueOrDefault<int>*/, ::g::Uno::Int_typeof(), NULL), opts, uString::Const("y"), uCRef<int>(0), &ret6), ret6);
        width = (::g::Fuse::Scripting::JSObjectUtils__ValueOrDefault_fn(::g::Fuse::Scripting::JSObjectUtils_typeof()->MakeMethod(0/*ValueOrDefault<int>*/, ::g::Uno::Int_typeof(), NULL), opts, ::STRINGS[2/*"width"*/], uCRef<int>(0), &ret7), ret7);
        height = (::g::Fuse::Scripting::JSObjectUtils__ValueOrDefault_fn(::g::Fuse::Scripting::JSObjectUtils_typeof()->MakeMethod(0/*ValueOrDefault<int>*/, ::g::Uno::Int_typeof(), NULL), opts, ::STRINGS[2/*"width"*/], uCRef<int>(width), &ret8), ret8);
...
::g::Uno::Threading::Future1* ImageTools::ImageFromBase64Interface(uArray* args)
{
    ...
    uString* str = (::g::Fuse::Scripting::JSObjectUtils__ValueOrDefault1_fn(::g::Fuse::Scripting::JSObjectUtils_typeof()->MakeMethod(1/*ValueOrDefault<string>*/, ::TYPES[3/*string*/], NULL), args, uCRef<int>(0), NULL, &ret10), ret10);
...
::g::Uno::Threading::Future1* ImageTools::ResizeImageInterface(uArray* args)
{
    ...
    ::g::Fuse::ImageTools::Image* image = ::g::Fuse::ImageTools::Image::FromObject1(uPtr(args)->Strong<uObject*>(0));
    ::g::Fuse::Scripting::Object* opts = uAs< ::g::Fuse::Scripting::Object*>(args->Strong<uObject*>(1), ::TYPES[4/*Fuse.Scripting.Object*/]);
    int w = (::g::Fuse::Scripting::JSObjectUtils__ValueOrDefault_fn(::g::Fuse::Scripting::JSObjectUtils_typeof()->MakeMethod(0/*ValueOrDefault<int>*/, ::g::Uno::Int_typeof(), NULL), opts, uString::Const("desiredWidth"), uCRef<int>(-1), &ret11), ret11);

    if (w == -1)
        U_THROW(::g::Uno::Exception::New2(uString::Const("desiredWidth must be defined")));

    int h = (::g::Fuse::Scripting::JSObjectUtils__ValueOrDefault_fn(::g::Fuse::Scripting::JSObjectUtils_typeof()->MakeMethod(0/*ValueOrDefault<int>*/, ::g::Uno::Int_typeof(), NULL), opts, uString::Const("desiredHeight"), uCRef<int>(w), &ret12), ret12);
    int m = (::g::Fuse::Scripting::JSObjectUtils__ValueOrDefault_fn(::g::Fuse::Scripting::JSObjectUtils_typeof()->MakeMethod(0/*ValueOrDefault<int>*/, ::g::Uno::Int_typeof(), NULL), opts, uString::Const("mode"), uCRef<int>(3), &ret13), ret13);
