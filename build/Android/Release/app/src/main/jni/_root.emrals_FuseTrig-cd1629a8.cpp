...
// internal sealed class emrals_FuseTriggersTimeline_TargetProgress_Property :75
// {
static void emrals_FuseTriggersTimeline_TargetProgress_Property_build(uType* type)
{
    ...
    type->SetFields(1,
        ::TYPES[0/*Fuse.Triggers.Timeline*/], offsetof(::g::emrals_FuseTriggersTimeline_TargetProgress_Property, _obj), uFieldFlagsWeak);
}
...
// public emrals_FuseTriggersTimeline_TargetProgress_Property(Fuse.Triggers.Timeline obj, Uno.UX.Selector name) :78
...
// public override sealed double Get(Uno.UX.PropertyObject obj) :80
...
// public emrals_FuseTriggersTimeline_TargetProgress_Property New(Fuse.Triggers.Timeline obj, Uno.UX.Selector name) :78
...
// public override sealed void Set(Uno.UX.PropertyObject obj, double v, Uno.UX.IPropertyListener origin) :81
...
// public emrals_FuseTriggersTimeline_TargetProgress_Property(Fuse.Triggers.Timeline obj, Uno.UX.Selector name) [instance] :78
...
// public emrals_FuseTriggersTimeline_TargetProgress_Property New(Fuse.Triggers.Timeline obj, Uno.UX.Selector name) [static] :78
