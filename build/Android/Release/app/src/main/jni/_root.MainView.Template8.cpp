...
{
    MainView__Template8::__selector0_ = ::g::Uno::UX::Selector__op_Implicit(::STRINGS[0/*"payment"*/]);
}

static void MainView__Template8_build(uType* type)
{
    ::STRINGS[0] = uString::Const("payment");
    type->SetFields(2,
...
{
    ::g::PaymentPage* __self1 = ::g::PaymentPage::New5(uPtr(__this->__parent1)->router);
