// This file was generated based on '.uno/ux13/Cat.g.uno'.
...
// {
// static Cat() :4
static void Cat__cctor_4_fn(uType* __type)
{
}

static void Cat_build(uType* type)
{
    type->SetInterfaces(
...
::g::Fuse::Controls::TextControl_type* Cat_typeof()
{
    ...
    options.ObjectSize = sizeof(Cat);
    options.TypeSize = sizeof(::g::Fuse::Controls::TextControl_type);
    type = (::g::Fuse::Controls::TextControl_type*)uClassType::New("Cat", options);
    type->fp_build_ = Cat_build;
    type->fp_ctor_ = (void*)Cat__New4_fn;
    type->fp_cctor_ = Cat__cctor_4_fn;
...
// public Cat New() [static] :8
Cat* Cat::New4()
{
    Cat* obj1 = (Cat*)uNew(Cat_typeof());
    obj1->ctor_8();
    return obj1;
}
// }
