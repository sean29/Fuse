...
// C:\Users\q\AppData\Local\Fusetools\Packages\Fuse.Camera\1.3.0-rc2\Android\AndroidCamera.uno
// -------------------------------------------------------------------------------------------
...
// C:\Users\q\AppData\Local\Fusetools\Packages\Fuse.Camera\1.3.0-rc2\Camera.uno
// ----------------------------------------------------------------------------
...
{
    {
        ...
        WITH_STATIC_JAVA_METHOD(__mtd, __cls, "HandleIntent380", "(Lcom/uno/UnoObject;ILjava/lang/Object;Ljava/lang/Object;Lcom/foreign/Uno/Action_String;Lcom/foreign/Uno/Action_String;)V");
        uObject* _uthis=this;
...
{
    {
        INIT_JNI;
        jclass __cls = JniHelper::GetNativeExternClass();
        WITH_STATIC_JAVA_METHOD(__mtd, __cls, "CreateImage381", "()Ljava/lang/Object;");
...
{
    {
        INIT_JNI;
        jclass __cls = JniHelper::GetNativeExternClass();
        WITH_STATIC_JAVA_METHOD(__mtd, __cls, "CreateIntent382", "(Ljava/lang/Object;)Ljava/lang/Object;");
        ::g::Java::Object* _uphoto=photo;
        jobject _photo = (_uphoto==NULL ? NULL : U_JNIVAR->NewLocalRef(::g::Android::Base::Wrappers::IJWrapper::_GetJavaObject(uInterface((uObject*)_uphoto, ::g::Android::Base::Wrappers::IJWrapper_typeof()))));
