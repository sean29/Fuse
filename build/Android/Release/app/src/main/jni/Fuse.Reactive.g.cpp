...
// C:\Users\q\AppData\Local\Fusetools\Packages\Fuse.Reactive.Expressions\1.2.0\$.uno
// ---------------------------------------------------------------------------------
...
// C:\Users\q\AppData\Local\Fusetools\Packages\Fuse.Reactive.JavaScript\1.2.0\$.uno
// --------------------------------------------------------------------------------
...
// C:\Users\q\AppData\Local\Fusetools\Packages\Fuse.Reactive.Bindings\1.2.0\$.uno
// ------------------------------------------------------------------------------
...
static void FunctionMirror__CallClosure_build(uType* type)
{
    ...
    ::STRINGS[6] = uString::Const("C:\\Users\\q\\AppData\\Local\\Fusetools\\Packages\\Fuse.Reactive.JavaScript\\1.2.0\\$.uno");
...
void FunctionMirror__CallClosure::Call()
{
    ...
    catch (const uThrowable& __t)
    {
        if (uIs(__t.Exception, ::TYPES[12/*Fuse.Scripting.ScriptException*/]))
        {
            ...
            ::g::Fuse::Reactive::JavaScript::UserScriptError(::STRINGS[5/*"JavaScript ...*/], ex, this, ::STRINGS[6/*"C:\\Users\\...*/], 234, ::STRINGS[7/*"Call"*/]);
        }
        else throw __t;
    }
}
...
static void DataBinding_build(uType* type)
{
    ...
    ::STRINGS[34] = uString::Const("C:\\Users\\q\\AppData\\Local\\Fusetools\\Packages\\Fuse.Reactive.Bindings\\1.2.0\\$.uno");
...
void DataBinding::TryPushAsMarshalledValue(uObject* newValue)
{
    ...
    if (::g::Fuse::Marshal::TryConvertTo(uPtr(Target())->PropertyType(), newValue, &res, this))
    {
        ...
        catch (const uThrowable& __t)
        {
            ...
            ::g::Fuse::Diagnostics::UserError(e->ToString(), Target(), ::STRINGS[34/*"C:\\Users\\...*/], 421, ::STRINGS[36/*"TryPushAsMa...*/], NULL);
        }
    }
}
...
// C:\Users\q\AppData\Local\Fusetools\Packages\Fuse.Reactive.Bindings\1.2.0\subscription\$.uno
// -------------------------------------------------------------------------------------------
...
// C:\Users\q\AppData\Local\Fusetools\Packages\Fuse.Reactive\1.2.0\$.uno
// ---------------------------------------------------------------------
...
void Instantiator::AddTemplate(Instantiator__WindowItem* item, ::g::Uno::UX::Template* f)
{
    ...
    if (elm == NULL)
    {
        ::g::Fuse::Diagnostics::InternalError(::STRINGS[48/*"Template co...*/], this, ::STRINGS[34/*"C:\\Users\\...*/], 1978, ::STRINGS[49/*"AddTemplate"*/]);
        return;
    }
...
void Instantiator::CompleteWindowItem(Instantiator__WindowItem* wi, int windowIndex)
{
    ...
    if ((wi->Template.All && (::g::Uno::Collections::ICollection::Count(uInterface(uPtr(Templates()), ::TYPES[50/*Uno.Collections.ICollection<Uno.UX.Template>*/])) != uPtr(wi->Nodes)->Count())) || ((wi->Template.Template != NULL) && (uPtr(wi->Nodes)->Count() != 1)))
        ::g::Fuse::Diagnostics::InternalError(::STRINGS[50/*"inconsisten...*/], this, ::STRINGS[34/*"C:\\Users\\...*/], 1891, ::STRINGS[51/*"CompleteWin...*/]);
...
void Instantiator::Limit(int value)
{
    ...
    if (value < 0)
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[52/*"Limit canno...*/], this, ::STRINGS[34/*"C:\\Users\\...*/], 1148, ::STRINGS[53/*"set_Limit"*/], NULL);
        value = 0;
    }
...
void Instantiator::Offset(int value)
{
    ...
    if (value < 0)
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[54/*"Offset cann...*/], this, ::STRINGS[34/*"C:\\Users\\...*/], 1100, ::STRINGS[55/*"set_Offset"*/], NULL);
        value = 0;
    }
...
void InstantiatorFunction__Subscribe_fn(InstantiatorFunction* __this, uObject* context, uObject* listener, uObject** __retval)
{
    ...
    {
        ::g::Fuse::Diagnostics::UserError(::g::Uno::String::op_Addition2(::STRINGS[58/*"too many pa...*/], ::g::Uno::UX::Selector__op_Implicit1(__this->_item)), __this, ::STRINGS[34/*"C:\\Users\\...*/], 2311, ::STRINGS[59/*"Subscribe"*/], NULL);
        return *__retval = NULL, void();
    }
...
void InstantiatorFunction__InstantiatorSubscription::OnNewNode(uObject* obj)
{
    ...
    if (searchNode == NULL)
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[60/*"invalid sea...*/], this, ::STRINGS[34/*"C:\\Users\\...*/], 2369, ::STRINGS[61/*"OnNewNode"*/], NULL);
        return;
    }
    ...
    if (_instantiator == NULL)
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[62/*"Could not f...*/], this, ::STRINGS[34/*"C:\\Users\\...*/], 2376, ::STRINGS[61/*"OnNewNode"*/], NULL);
        return;
    }
    ...
    if (p == NULL)
    {
        ::g::Fuse::Diagnostics::InternalError(::STRINGS[63/*"Unable to r...*/], this, ::STRINGS[34/*"C:\\Users\\...*/], 2387, ::STRINGS[61/*"OnNewNode"*/]);
        return;
    }
...
void ModuleInstance::EvaluateModule()
{
...

    {
        ...
        if (newModuleResult->Error() == NULL)
        {
            ...
            {
                ::g::Fuse::Diagnostics::UserSuccess(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::STRINGS[80/*"JavaScript ...*/], uPtr(_js)->FileName()), ::STRINGS[81/*" fixed!"*/]), this, ::STRINGS[6/*"C:\\Users\\...*/], 669, ::STRINGS[82/*"EvaluateMod...*/]);
        ...
        else
        {
            ...
            {
                ::g::Fuse::Reactive::JavaScript::UserScriptError(::STRINGS[83/*"JavaScript ...*/], se, this, ::STRINGS[6/*"C:\\Users\\...*/], 685, ::STRINGS[82/*"EvaluateMod...*/]);
...
void Observable__Subscription::SetExclusive(uObject* newValue)
{
    ...
    {
        ::g::Fuse::Diagnostics::InternalError(::STRINGS[118/*"Unexpected ...*/], this, ::STRINGS[6/*"C:\\Users\\...*/], 830, ::STRINGS[119/*"SetExclusive"*/]);
        return;
    }
    ...
    catch (const uThrowable& __t)
    {
        ...
        {
            ::g::Fuse::Scripting::ScriptException* ex = (::g::Fuse::Scripting::ScriptException*)__t.Exception;
            ::g::Fuse::Reactive::JavaScript::UserScriptError(::STRINGS[121/*"Failed to s...*/], ex, this, ::STRINGS[6/*"C:\\Users\\...*/], 845, ::STRINGS[119/*"SetExclusive"*/]);
        }
        else throw __t;
    }
}
...
void ThreadWorker::CheckAndThrow()
{
    ...
    {
        if (prev != NULL)
            ::g::Fuse::Diagnostics::UnknownException(::STRINGS[125/*"Skipped Exc...*/], next, this, ::STRINGS[6/*"C:\\Users\\...*/], 2053, ::STRINGS[126/*"CheckAndThrow"*/]);
...
uObject* ThreadWorker::CreateMirror(uObject* obj)
{
    ...
    {
        ::g::Fuse::Diagnostics::UserWarning(::STRINGS[127/*"JavaScript ...*/], this, ::STRINGS[6/*"C:\\Users\\...*/], 1623, ::STRINGS[128/*"CreateMirror"*/]);
        return NULL;
    }
...
void ThreadWorker::Run()
{
    ...
    {
        ::g::Uno::Exception* e = __t.Exception;
        ::g::Fuse::Diagnostics::UnknownException(::STRINGS[139/*"ThreadWorke...*/], e, this, ::STRINGS[6/*"C:\\Users\\...*/], 1949, ::STRINGS[140/*"Run"*/]);
