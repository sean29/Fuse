...
{
    MainView__Template1::__selector0_ = ::g::Uno::UX::Selector__op_Implicit(::STRINGS[0/*"alerts"*/]);
}

static void MainView__Template1_build(uType* type)
{
    ::STRINGS[0] = uString::Const("alerts");
    type->SetFields(2,
...
{
    ::g::AlertsPage* __self1 = ::g::AlertsPage::New5(uPtr(__this->__parent1)->router);
