...
static void CogWheelReload_build(uType* type)
{
    ...
    ::STRINGS[17] = uString::Const("temp_eb31");
    ...
    type->SetFields(105,
        ...
        ::g::Fuse::Reactive::EventBinding_typeof(), offsetof(::g::CogWheelReload, temp_eb31), 0,
...
void CogWheelReload::InitializeUX()
{
    ...
    temp_eb31 = ::g::Fuse::Reactive::EventBinding::New1((uObject*)temp2, __g_nametable1);
    ClipToBounds(true);
    ...
    temp->add_ReloadHandler(uDelegate::New(::TYPES[6/*Fuse.VisualEventHandler*/], (void*)::g::Fuse::Reactive::EventBinding__OnEvent_fn, uPtr(temp_eb31)));
    temp->Pulling(temp19);
    ...
    ::g::Uno::Collections::ICollection::Add_ex(uInterface(uPtr(temp->Bindings()), ::TYPES[7/*Uno.Collections.ICollection<Fuse.Binding>*/]), temp_eb31);
    ...
    ::g::Uno::Collections::ICollection::Add_ex(uInterface(uPtr(uPtr(__g_nametable1)->Objects()), ::TYPES[9/*Uno.Collections.ICollection<object>*/]), temp_eb31);
