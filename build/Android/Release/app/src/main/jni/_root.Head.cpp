// This file was generated based on '.uno/ux11/Head.g.uno'.
...
// public partial sealed class Head :2
// {
// static Head() :4
static void Head__cctor_4_fn(uType* __type)
{
}

static void Head_build(uType* type)
{
    type->SetInterfaces(
...
::g::Fuse::Controls::TextControl_type* Head_typeof()
{
    ...
    options.ObjectSize = sizeof(Head);
    options.TypeSize = sizeof(::g::Fuse::Controls::TextControl_type);
    type = (::g::Fuse::Controls::TextControl_type*)uClassType::New("Head", options);
    type->fp_build_ = Head_build;
    type->fp_ctor_ = (void*)Head__New4_fn;
    type->fp_cctor_ = Head__cctor_4_fn;
...
// public Head() :8
void Head__ctor_8_fn(Head* __this)
{
    __this->ctor_8();
}

// private void InitializeUX() :12
void Head__InitializeUX1_fn(Head* __this)
{
    __this->InitializeUX1();
}

// public Head New() :8
void Head__New4_fn(Head** __retval)
{
    *__retval = Head::New4();
}

// public Head() [instance] :8
void Head::ctor_8()
{
    ctor_7();
    InitializeUX1();
...
void Head::InitializeUX1()
{
    FontSize(20.0f);
    Color(::g::Uno::Float4__New2(0.3882353f, 0.3882353f, 0.3921569f, 1.0f));
    Font(::g::AlertDetailPage::Head());
}

// public Head New() [static] :8
Head* Head::New4()
{
    Head* obj1 = (Head*)uNew(Head_typeof());
    obj1->ctor_8();
    return obj1;
}
// }
