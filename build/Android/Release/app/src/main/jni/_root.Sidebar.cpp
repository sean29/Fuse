...
{
    Sidebar::__g_static_nametable1_ = uArray::Init<uString*>(::TYPES[0/*string[]*/], 10, ::STRINGS[0/*"user"*/], ::STRINGS[1/*"temp_eb2"*/], ::STRINGS[2/*"stats"*/], ::STRINGS[3/*"browser"*/], ::STRINGS[4/*"temp_eb3"*/], ::STRINGS[5/*"temp_eb4"*/], ::STRINGS[6/*"feed"*/], ::STRINGS[7/*"temp_eb5"*/], ::STRINGS[8/*"chat"*/], ::STRINGS[9/*"temp_eb6"*/]);
    Sidebar::__selector0_ = ::g::Uno::UX::Selector__op_Implicit(::STRINGS[10/*"Url"*/]);
    Sidebar::__selector1_ = ::g::Uno::UX::Selector__op_Implicit(::STRINGS[11/*"Value"*/]);
    Sidebar::__selector2_ = ::g::Uno::UX::Selector__op_Implicit(::STRINGS[0/*"user"*/]);
    Sidebar::__selector3_ = ::g::Uno::UX::Selector__op_Implicit(::STRINGS[2/*"stats"*/]);
    Sidebar::__selector4_ = ::g::Uno::UX::Selector__op_Implicit(::STRINGS[3/*"browser"*/]);
    Sidebar::__selector5_ = ::g::Uno::UX::Selector__op_Implicit(::STRINGS[6/*"feed"*/]);
    Sidebar::__selector6_ = ::g::Uno::UX::Selector__op_Implicit(::STRINGS[8/*"chat"*/]);
}
...
static void Sidebar_build(uType* type)
{
    ...
    ::STRINGS[2] = uString::Const("stats");
    ::STRINGS[3] = uString::Const("browser");
    ::STRINGS[4] = uString::Const("temp_eb3");
    ::STRINGS[5] = uString::Const("temp_eb4");
    ::STRINGS[6] = uString::Const("feed");
    ::STRINGS[7] = uString::Const("temp_eb5");
    ::STRINGS[8] = uString::Const("chat");
    ::STRINGS[9] = uString::Const("temp_eb6");
    ...
    ::STRINGS[14] = uString::Const("user_name");
    ::STRINGS[15] = uString::Const("user_emrals");
    ::STRINGS[16] = uString::Const("user_xp");
    ::STRINGS[17] = uString::Const("goToAlerts");
    ::STRINGS[18] = uString::Const("selectImage");
    ::STRINGS[19] = uString::Const("goToImpact");
    ::STRINGS[20] = uString::Const("goToEcans");
    ::STRINGS[21] = uString::Const("Emrals");
    ::STRINGS[22] = uString::Const("XP");
    ::STRINGS[23] = uString::Const("0");
    ::STRINGS[24] = uString::Const("Zones");
    ::STRINGS[25] = uString::Const("dirt alerts");
    ::STRINGS[26] = uString::Const("solutions");
    ::STRINGS[27] = uString::Const("POST");
    ::STRINGS[28] = uString::Const("UPLOAD");
    ::STRINGS[29] = uString::Const("impact zones");
    ::STRINGS[30] = uString::Const("Cooper Impact");
    ::STRINGS[31] = uString::Const("CREATE IMPACT");
    ::STRINGS[32] = uString::Const("ecans");
    ::STRINGS[33] = uString::Const("BUY ECAN");
    ...
    ::TYPES[6] = ::g::Uno::Collections::ICollection_typeof()->MakeType(::g::Fuse::Drawing::Brush_typeof(), NULL);
    ...
    type->SetFields(106,
        ...
        ::g::Fuse::Reactive::EventBinding_typeof(), offsetof(::g::Sidebar, temp_eb4), 0,
        ::g::Fuse::Reactive::EventBinding_typeof(), offsetof(::g::Sidebar, temp_eb5), 0,
        ::g::Fuse::Reactive::EventBinding_typeof(), offsetof(::g::Sidebar, temp_eb6), 0,
        ::g::Uno::UX::Property1_typeof()->MakeType(::g::Uno::String_typeof(), NULL), offsetof(::g::Sidebar, temp_Url_inst), 0,
        ...
        ::g::Uno::UX::Property1_typeof()->MakeType(::g::Uno::String_typeof(), NULL), offsetof(::g::Sidebar, temp3_Value_inst), 0,
        ...
        ::g::Uno::UX::Selector_typeof(), (uintptr_t)&::g::Sidebar::__selector6_, uFieldFlagsStatic);
}
...
{
    ::g::Fuse::Reactive::Data* temp4 = ::g::Fuse::Reactive::Data::New1(::STRINGS[12/*"viewProfile"*/]);
    ...
    temp_Url_inst = ::g::emrals_FuseDrawingImageFill_Url_Property::New1(temp, Sidebar::__selector0());
    ::g::Fuse::Reactive::Data* temp5 = ::g::Fuse::Reactive::Data::New1(::STRINGS[13/*"user_avatar"*/]);
    ::g::Username* temp1 = ::g::Username::New4();
    temp1_Value_inst = ::g::emrals_FuseControlsTextControl_Value_Property::New1(temp1, Sidebar::__selector1());
    ::g::Fuse::Reactive::Data* temp6 = ::g::Fuse::Reactive::Data::New1(::STRINGS[14/*"user_name"*/]);
    ::g::Stats* temp2 = ::g::Stats::New4();
    temp2_Value_inst = ::g::emrals_FuseControlsTextControl_Value_Property::New1(temp2, Sidebar::__selector1());
    ::g::Fuse::Reactive::Data* temp7 = ::g::Fuse::Reactive::Data::New1(::STRINGS[15/*"user_emrals"*/]);
    ::g::Stats* temp3 = ::g::Stats::New4();
    temp3_Value_inst = ::g::emrals_FuseControlsTextControl_Value_Property::New1(temp3, Sidebar::__selector1());
    ::g::Fuse::Reactive::Data* temp8 = ::g::Fuse::Reactive::Data::New1(::STRINGS[16/*"user_xp"*/]);
    ::g::Fuse::Reactive::Data* temp9 = ::g::Fuse::Reactive::Data::New1(::STRINGS[17/*"goToAlerts"*/]);
    ::g::Fuse::Reactive::Data* temp10 = ::g::Fuse::Reactive::Data::New1(::STRINGS[18/*"selectImage"*/]);
    ::g::Fuse::Reactive::Data* temp11 = ::g::Fuse::Reactive::Data::New1(::STRINGS[19/*"goToImpact"*/]);
    ::g::Fuse::Reactive::Data* temp12 = ::g::Fuse::Reactive::Data::New1(::STRINGS[20/*"goToEcans"*/]);
    ...
    ::g::Fuse::Reactive::DataBinding* temp26 = ::g::Fuse::Reactive::DataBinding::New1(temp_Url_inst, (uObject*)temp5, __g_nametable1, 3);
    ::g::Fuse::Reactive::DataBinding* temp27 = ::g::Fuse::Reactive::DataBinding::New1(temp1_Value_inst, (uObject*)temp6, __g_nametable1, 3);
    stats = ::g::Fuse::Controls::Grid::New4();
    ::g::Fuse::Controls::StackPanel* temp28 = ::g::Fuse::Controls::StackPanel::New4();
    ::g::Fuse::Reactive::DataBinding* temp29 = ::g::Fuse::Reactive::DataBinding::New1(temp2_Value_inst, (uObject*)temp7, __g_nametable1, 3);
    ...
    ::g::Fuse::Reactive::DataBinding* temp34 = ::g::Fuse::Reactive::DataBinding::New1(temp3_Value_inst, (uObject*)temp8, __g_nametable1, 3);
    ...
    temp_eb4 = ::g::Fuse::Reactive::EventBinding::New1((uObject*)temp10, __g_nametable1);
    ...
    temp_eb5 = ::g::Fuse::Reactive::EventBinding::New1((uObject*)temp11, __g_nametable1);
    ...
    temp_eb6 = ::g::Fuse::Reactive::EventBinding::New1((uObject*)temp12, __g_nametable1);
    ...
    ::g::Uno::Collections::ICollection::Add_ex(uInterface(uPtr(temp13->Animators()), ::TYPES[1/*Uno.Collections.ICollection<Fuse.Animations.Animator>*/]), temp15);
    ::g::Uno::Collections::ICollection::Add_ex(uInterface(uPtr(temp13->Animators()), ::TYPES[1/*Uno.Collections.ICollection<Fuse.Animations.Animator>*/]), temp16);
    ::g::Uno::Collections::ICollection::Add_ex(uInterface(uPtr(temp13->Animators()), ::TYPES[1/*Uno.Collections.ICollection<Fuse.Animations.Animator>*/]), temp17);
    ::g::Uno::Collections::ICollection::Add_ex(uInterface(uPtr(temp13->Animators()), ::TYPES[1/*Uno.Collections.ICollection<Fuse.Animations.Animator>*/]), temp18);
    temp14->X(-180.0f);
    temp14->Duration(0.2);
    temp14->Delay(0.3);
    temp14->Target(user);
    ...
    temp18->Delay(0.05);
    temp18->Target(chat);
    temp18->Easing(::g::Fuse::Animations::Easing::CircularIn());
    temp19->Background(temp20);
    uPtr(user)->Name(Sidebar::__selector2());
    ::g::Uno::Collections::ICollection::Add_ex(uInterface(uPtr(uPtr(user)->Children()), ::TYPES[2/*Uno.Collections.ICollection<Fuse.Node>*/]), temp21);
    ::g::Uno::Collections::ICollection::Add_ex(uInterface(uPtr(uPtr(user)->Children()), ::TYPES[2/*Uno.Collections.ICollection<Fuse.Node>*/]), temp24);
    ::g::Uno::Collections::ICollection::Add_ex(uInterface(uPtr(uPtr(user)->Children()), ::TYPES[2/*Uno.Collections.ICollection<Fuse.Node>*/]), temp25);
    ::g::Uno::Collections::ICollection::Add_ex(uInterface(uPtr(uPtr(user)->Children()), ::TYPES[2/*Uno.Collections.ICollection<Fuse.Node>*/]), temp1);
    ::g::Uno::Collections::ICollection::Add_ex(uInterface(uPtr(temp21->Actions()), ::TYPES[3/*Uno.Collections.ICollection<Fuse.Triggers.Actions.TriggerAction>*/]), temp22);
    ::g::Uno::Collections::ICollection::Add_ex(uInterface(uPtr(temp21->Actions()), ::TYPES[3/*Uno.Collections.ICollection<Fuse.Triggers.Actions.TriggerAction>*/]), temp23);
    ::g::Uno::Collections::ICollection::Add_ex(uInterface(uPtr(temp21->Bindings()), ::TYPES[4/*Uno.Collections.ICollection<Fuse.Binding>*/]), temp_eb2);
    temp23->add_Handler(uDelegate::New(::TYPES[5/*Fuse.VisualEventHandler*/], (void*)::g::Fuse::Reactive::EventBinding__OnEvent_fn, uPtr(temp_eb2)));
    ...
    ::g::Uno::Collections::ICollection::Add_ex(uInterface(uPtr(temp25->Fills()), ::TYPES[6/*Uno.Collections.ICollection<Fuse.Drawing.Brush>*/]), temp);
    ::g::Uno::Collections::ICollection::Add_ex(uInterface(uPtr(temp25->Bindings()), ::TYPES[4/*Uno.Collections.ICollection<Fuse.Binding>*/]), temp26);
    temp->WrapMode(1);
    ::g::Uno::Collections::ICollection::Add_ex(uInterface(uPtr(temp1->Bindings()), ::TYPES[4/*Uno.Collections.ICollection<Fuse.Binding>*/]), temp27);
    uPtr(stats)->ColumnCount(5);
    uPtr(stats)->Alignment(2);
    uPtr(stats)->Margin(::g::Uno::Float4__New2(0.0f, 10.0f, 0.0f, 30.0f));
    uPtr(stats)->Name(Sidebar::__selector3());
    ::g::Uno::Collections::ICollection::Add_ex(uInterface(uPtr(uPtr(stats)->Children()), ::TYPES[2/*Uno.Collections.ICollection<Fuse.Node>*/]), temp28);
    ::g::Uno::Collections::ICollection::Add_ex(uInterface(uPtr(uPtr(stats)->Children()), ::TYPES[2/*Uno.Collections.ICollection<Fuse.Node>*/]), temp31);
    ::g::Uno::Collections::ICollection::Add_ex(uInterface(uPtr(uPtr(stats)->Children()), ::TYPES[2/*Uno.Collections.ICollection<Fuse.Node>*/]), temp33);
    ::g::Uno::Collections::ICollection::Add_ex(uInterface(uPtr(uPtr(stats)->Children()), ::TYPES[2/*Uno.Collections.ICollection<Fuse.Node>*/]), temp36);
    ::g::Uno::Collections::ICollection::Add_ex(uInterface(uPtr(uPtr(stats)->Children()), ::TYPES[2/*Uno.Collections.ICollection<Fuse.Node>*/]), temp38);
    temp28->Width(::g::Uno::UX::Size__New1(50.0f, 1));
    ::g::Uno::Collections::ICollection::Add_ex(uInterface(uPtr(temp28->Children()), ::TYPES[2/*Uno.Collections.ICollection<Fuse.Node>*/]), temp2);
    ::g::Uno::Collections::ICollection::Add_ex(uInterface(uPtr(temp28->Children()), ::TYPES[2/*Uno.Collections.ICollection<Fuse.Node>*/]), temp30);
    ::g::Uno::Collections::ICollection::Add_ex(uInterface(uPtr(temp2->Bindings()), ::TYPES[4/*Uno.Collections.ICollection<Fuse.Binding>*/]), temp29);
    temp30->Value(::STRINGS[21/*"Emrals"*/]);
    temp31->Width(::g::Uno::UX::Size__New1(1.0f, 1));
    temp31->Height(::g::Uno::UX::Size__New1(40.0f, 1));
    ::g::Uno::Collections::ICollection::Add_ex(uInterface(uPtr(temp31->Fills()), ::TYPES[6/*Uno.Collections.ICollection<Fuse.Drawing.Brush>*/]), temp32);
    temp32->Color(::g::Uno::Float4__New2(0.254902f, 0.3098039f, 0.3686275f, 1.0f));
    temp33->Width(::g::Uno::UX::Size__New1(50.0f, 1));
    ::g::Uno::Collections::ICollection::Add_ex(uInterface(uPtr(temp33->Children()), ::TYPES[2/*Uno.Collections.ICollection<Fuse.Node>*/]), temp3);
    ...
    ::g::Uno::Collections::ICollection::Add_ex(uInterface(uPtr(temp3->Bindings()), ::TYPES[4/*Uno.Collections.ICollection<Fuse.Binding>*/]), temp34);
    temp35->Value(::STRINGS[22/*"XP"*/]);
    temp36->Width(::g::Uno::UX::Size__New1(1.0f, 1));
    temp36->Height(::g::Uno::UX::Size__New1(40.0f, 1));
    ::g::Uno::Collections::ICollection::Add_ex(uInterface(uPtr(temp36->Fills()), ::TYPES[6/*Uno.Collections.ICollection<Fuse.Drawing.Brush>*/]), temp37);
    ...
    temp39->Value(::STRINGS[23/*"0"*/]);
    temp40->Value(::STRINGS[24/*"Zones"*/]);
    ::g::Uno::Collections::ICollection::Add_ex(uInterface(uPtr(temp41->Children()), ::TYPES[2/*Uno.Collections.ICollection<Fuse.Node>*/]), browser);
    ::g::Uno::Collections::ICollection::Add_ex(uInterface(uPtr(temp41->Children()), ::TYPES[2/*Uno.Collections.ICollection<Fuse.Node>*/]), feed);
    ::g::Uno::Collections::ICollection::Add_ex(uInterface(uPtr(temp41->Children()), ::TYPES[2/*Uno.Collections.ICollection<Fuse.Node>*/]), chat);
    uPtr(browser)->Name(Sidebar::__selector4());
    ::g::Uno::Collections::ICollection::Add_ex(uInterface(uPtr(uPtr(browser)->Children()), ::TYPES[2/*Uno.Collections.ICollection<Fuse.Node>*/]), temp42);
    ::g::Uno::Collections::ICollection::Add_ex(uInterface(uPtr(uPtr(browser)->Children()), ::TYPES[2/*Uno.Collections.ICollection<Fuse.Node>*/]), temp45);
    ::g::Uno::Collections::ICollection::Add_ex(uInterface(uPtr(temp42->Actions()), ::TYPES[3/*Uno.Collections.ICollection<Fuse.Triggers.Actions.TriggerAction>*/]), temp43);
    ::g::Uno::Collections::ICollection::Add_ex(uInterface(uPtr(temp42->Actions()), ::TYPES[3/*Uno.Collections.ICollection<Fuse.Triggers.Actions.TriggerAction>*/]), temp44);
    ::g::Uno::Collections::ICollection::Add_ex(uInterface(uPtr(temp42->Bindings()), ::TYPES[4/*Uno.Collections.ICollection<Fuse.Binding>*/]), temp_eb3);
    temp44->add_Handler(uDelegate::New(::TYPES[5/*Fuse.VisualEventHandler*/], (void*)::g::Fuse::Reactive::EventBinding__OnEvent_fn, uPtr(temp_eb3)));
    temp45->RowCount(2);
    ...
    ::g::Uno::Collections::ICollection::Add_ex(uInterface(uPtr(temp45->Children()), ::TYPES[2/*Uno.Collections.ICollection<Fuse.Node>*/]), temp47);
    ::g::Uno::Collections::ICollection::Add_ex(uInterface(uPtr(temp45->Children()), ::TYPES[2/*Uno.Collections.ICollection<Fuse.Node>*/]), temp48);
    ::g::Uno::Collections::ICollection::Add_ex(uInterface(uPtr(temp45->Children()), ::TYPES[2/*Uno.Collections.ICollection<Fuse.Node>*/]), temp50);
    temp46->Value(::STRINGS[25/*"dirt alerts"*/]);
    ...
    temp47->Value(::STRINGS[26/*"solutions"*/]);
    ...
    ::g::Fuse::Gestures::Clicked::AddHandler(temp50, uDelegate::New(::TYPES[7/*Fuse.Gestures.ClickedHandler*/], (void*)::g::Fuse::Reactive::EventBinding__OnEvent_fn, uPtr(temp_eb4)));
    ...
    ::g::Uno::Collections::ICollection::Add_ex(uInterface(uPtr(temp50->Bindings()), ::TYPES[4/*Uno.Collections.ICollection<Fuse.Binding>*/]), temp_eb4);
    temp51->Value(::STRINGS[28/*"UPLOAD"*/]);
    uPtr(feed)->Name(Sidebar::__selector5());
    ::g::Uno::Collections::ICollection::Add_ex(uInterface(uPtr(uPtr(feed)->Children()), ::TYPES[2/*Uno.Collections.ICollection<Fuse.Node>*/]), temp52);
    ::g::Uno::Collections::ICollection::Add_ex(uInterface(uPtr(uPtr(feed)->Children()), ::TYPES[2/*Uno.Collections.ICollection<Fuse.Node>*/]), temp55);
    ::g::Uno::Collections::ICollection::Add_ex(uInterface(uPtr(uPtr(feed)->Children()), ::TYPES[2/*Uno.Collections.ICollection<Fuse.Node>*/]), temp56);
    ::g::Uno::Collections::ICollection::Add_ex(uInterface(uPtr(uPtr(feed)->Children()), ::TYPES[2/*Uno.Collections.ICollection<Fuse.Node>*/]), temp63);
    ::g::Uno::Collections::ICollection::Add_ex(uInterface(uPtr(temp52->Actions()), ::TYPES[3/*Uno.Collections.ICollection<Fuse.Triggers.Actions.TriggerAction>*/]), temp53);
    ::g::Uno::Collections::ICollection::Add_ex(uInterface(uPtr(temp52->Actions()), ::TYPES[3/*Uno.Collections.ICollection<Fuse.Triggers.Actions.TriggerAction>*/]), temp54);
    ::g::Uno::Collections::ICollection::Add_ex(uInterface(uPtr(temp52->Bindings()), ::TYPES[4/*Uno.Collections.ICollection<Fuse.Binding>*/]), temp_eb5);
    temp54->add_Handler(uDelegate::New(::TYPES[5/*Fuse.VisualEventHandler*/], (void*)::g::Fuse::Reactive::EventBinding__OnEvent_fn, uPtr(temp_eb5)));
    temp55->Value(::STRINGS[29/*"impact zones"*/]);
    ...
    ::g::Uno::Collections::ICollection::Add_ex(uInterface(uPtr(temp56->Children()), ::TYPES[2/*Uno.Collections.ICollection<Fuse.Node>*/]), temp59);
    ::g::Uno::Collections::ICollection::Add_ex(uInterface(uPtr(temp56->Children()), ::TYPES[2/*Uno.Collections.ICollection<Fuse.Node>*/]), temp61);
    ::g::Uno::Collections::ICollection::Add_ex(uInterface(uPtr(temp56->Children()), ::TYPES[2/*Uno.Collections.ICollection<Fuse.Node>*/]), temp62);
    ...
    ::g::Uno::Collections::ICollection::Add_ex(uInterface(uPtr(temp57->Fills()), ::TYPES[6/*Uno.Collections.ICollection<Fuse.Drawing.Brush>*/]), temp58);
    temp58->File(::g::Uno::UX::BundleFileSource::New1(::g::emrals_bundle::mapdummyafdb29f3()));
    ...
    ::g::Uno::Collections::ICollection::Add_ex(uInterface(uPtr(temp59->Fills()), ::TYPES[6/*Uno.Collections.ICollection<Fuse.Drawing.Brush>*/]), temp60);
    temp60->File(::g::Uno::UX::BundleFileSource::New1(::g::emrals_bundle::mapdummyafdb29f3()));
    temp61->Value(::STRINGS[30/*"Cooper Impact"*/]);
    ...
    temp62->Value(::STRINGS[30/*"Cooper Impact"*/]);
    ...
    temp64->Value(::STRINGS[31/*"CREATE IMPACT"*/]);
    uPtr(chat)->Name(Sidebar::__selector6());
    ::g::Uno::Collections::ICollection::Add_ex(uInterface(uPtr(uPtr(chat)->Children()), ::TYPES[2/*Uno.Collections.ICollection<Fuse.Node>*/]), temp65);
    ::g::Uno::Collections::ICollection::Add_ex(uInterface(uPtr(uPtr(chat)->Children()), ::TYPES[2/*Uno.Collections.ICollection<Fuse.Node>*/]), temp68);
    ::g::Uno::Collections::ICollection::Add_ex(uInterface(uPtr(uPtr(chat)->Children()), ::TYPES[2/*Uno.Collections.ICollection<Fuse.Node>*/]), temp69);
    ::g::Uno::Collections::ICollection::Add_ex(uInterface(uPtr(uPtr(chat)->Children()), ::TYPES[2/*Uno.Collections.ICollection<Fuse.Node>*/]), temp70);
    ::g::Uno::Collections::ICollection::Add_ex(uInterface(uPtr(temp65->Actions()), ::TYPES[3/*Uno.Collections.ICollection<Fuse.Triggers.Actions.TriggerAction>*/]), temp66);
    ::g::Uno::Collections::ICollection::Add_ex(uInterface(uPtr(temp65->Actions()), ::TYPES[3/*Uno.Collections.ICollection<Fuse.Triggers.Actions.TriggerAction>*/]), temp67);
    ::g::Uno::Collections::ICollection::Add_ex(uInterface(uPtr(temp65->Bindings()), ::TYPES[4/*Uno.Collections.ICollection<Fuse.Binding>*/]), temp_eb6);
    temp67->add_Handler(uDelegate::New(::TYPES[5/*Fuse.VisualEventHandler*/], (void*)::g::Fuse::Reactive::EventBinding__OnEvent_fn, uPtr(temp_eb6)));
    temp68->Value(::STRINGS[32/*"ecans"*/]);
    temp68->FontSize(16.0f);
    temp68->Alignment(10);
    temp68->Margin(::g::Uno::Float4__New2(0.0f, 40.0f, 0.0f, 0.0f));
    temp69->MaxHeight(::g::Uno::UX::Size__New1(90.0f, 1));
    temp69->File(::g::Uno::UX::BundleFileSource::New1(::g::emrals_bundle::ecan439818c44()));
    ...
    temp71->Value(::STRINGS[33/*"BUY ECAN"*/]);
    uPtr(__g_nametable1)->This(this);
    ::g::Uno::Collections::ICollection::Add_ex(uInterface(uPtr(uPtr(__g_nametable1)->Objects()), ::TYPES[8/*Uno.Collections.ICollection<object>*/]), user);
    ...
    ::g::Uno::Collections::ICollection::Add_ex(uInterface(uPtr(uPtr(__g_nametable1)->Objects()), ::TYPES[8/*Uno.Collections.ICollection<object>*/]), stats);
    ::g::Uno::Collections::ICollection::Add_ex(uInterface(uPtr(uPtr(__g_nametable1)->Objects()), ::TYPES[8/*Uno.Collections.ICollection<object>*/]), browser);
    ...
    ::g::Uno::Collections::ICollection::Add_ex(uInterface(uPtr(uPtr(__g_nametable1)->Objects()), ::TYPES[8/*Uno.Collections.ICollection<object>*/]), feed);
    ...
    ::g::Uno::Collections::ICollection::Add_ex(uInterface(uPtr(uPtr(__g_nametable1)->Objects()), ::TYPES[8/*Uno.Collections.ICollection<object>*/]), chat);
    ::g::Uno::Collections::ICollection::Add_ex(uInterface(uPtr(uPtr(__g_nametable1)->Objects()), ::TYPES[8/*Uno.Collections.ICollection<object>*/]), temp_eb6);
    Background(temp72);
    ...
    ::g::Uno::Collections::ICollection::Add_ex(uInterface(uPtr(Children()), ::TYPES[2/*Uno.Collections.ICollection<Fuse.Node>*/]), temp41);
}

// public Sidebar New() [static] :35
