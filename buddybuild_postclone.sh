...
/usr/libexec/PlistBuddy -x -c "Set :FacebookAppID $FB_APP_ID" build/Release/iOS/src/Targets/iOS/Uno-iOS/emrals-Info.plist
/usr/libexec/PlistBuddy -x -c "Set :FacebookDisplayName Emrals" build/Release/iOS/src/Targets/iOS/Uno-iOS/emrals-Info.plist
/usr/libexec/PlistBuddy -x -c "Set :CFBundleURLTypes:0:CFBundleURLSchemes:0 fb$FB_APP_ID" build/Release/iOS/src/Targets/iOS/Uno-iOS/emrals-Info.plist
