...
jboolean JNICALL callUno_Android_ActivityUtils_OnReceived68(JNIEnv *env,jclass clazz,jint requestCode,jint resultCode,jobject data,jlong dataPtr)
{
    uAutoReleasePool pool;
    INIT_JNI;
...
jboolean JNICALL callUno_Fuse_Platform_SystemUI_firstSizingGet111(JNIEnv *env,jclass clazz)
{
    uAutoReleasePool pool;
    INIT_JNI;
    jboolean __jresult;
...
jboolean JNICALL callUno_Fuse_Platform_SystemUI_hasCachedStatusBarSizeGet94(JNIEnv *env,jclass clazz)
{
    uAutoReleasePool pool;
    INIT_JNI;
    jboolean __jresult;
...
jint JNICALL callUno_Fuse_Platform_SystemUI_cachedOpenSizeGet95(JNIEnv *env,jclass clazz)
{
    uAutoReleasePool pool;
    INIT_JNI;
    jint __jresult;
...
jint JNICALL callUno_Fuse_Platform_SystemUI_GetRealDisplayWidth102(JNIEnv *env,jclass clazz)
{
    uAutoReleasePool pool;
    INIT_JNI;
    jint __jresult;
...
jint JNICALL callUno_Fuse_Platform_SystemUI_lastKeyboardHeightGet110(JNIEnv *env,jclass clazz)
{
    uAutoReleasePool pool;
    INIT_JNI;
    jint __jresult;
...
jint JNICALL callUno_QreaderImpl_RC_BARCODE_CAPTUREGet450(JNIEnv *env,jclass clazz)
{
    uAutoReleasePool pool;
    INIT_JNI;
    jint __jresult;
    JTRY
        int __result=::g::QreaderImpl::RC_BARCODE_CAPTURE_;
        __jresult = (jint)__result;
    JCATCH
    return __jresult;
}
...
jobject JNICALL callUno_Fuse_Controls_Native_ViewHandle_NativeHandleGet239(JNIEnv *env,jclass clazz,jobject jthis)
{
    uAutoReleasePool pool;
    INIT_JNI;
...
jobject JNICALL callUno_Neovisionaries_WebSocketClient__webSocketGet434(JNIEnv *env,jclass clazz,jobject jthis)
{
    uAutoReleasePool pool;
    INIT_JNI;
...
jobject JNICALL callUno_Uno_IO_BundleFile_BundlePathGet319(JNIEnv *env,jclass clazz,jobject jthis)
{
    uAutoReleasePool pool;
    INIT_JNI;
...
void JNICALL callUno_Action_int_float_float(JNIEnv *env,jclass clazz,jobject theDelegate,jint arg1,jfloat arg2,jfloat arg3)
{
    ...
    int uno_arg1 = (int)arg1;
    float uno_arg2 = (float)arg2;
    float uno_arg3 = (float)arg3;
    JTRY
        uno_theDelegate->Invoke(3, uCRef<int>(uno_arg1), uCRef(uno_arg2), uCRef(uno_arg3));
    JCATCH
}
void JNICALL callUno_Action_int_String(JNIEnv *env,jclass clazz,jobject theDelegate,jint arg1,jobject arg2)
{
    ...
    JTRY
        uno_theDelegate->Invoke(2, uCRef<int>(uno_arg1), uCast<uString*>(uno_arg2, ::g::Uno::String_typeof()));
    JCATCH
}
...
void JNICALL callUno_Fuse_Android_AppRoot_OnTouchEvent__337(JNIEnv *env,jclass clazz,jobject motionEvent,jlong motionEventPtr)
{
    uAutoReleasePool pool;
    INIT_JNI;
    ::g::Java::Object* uno_motionEvent = (::g::Java::Object*)::g::Android::Base::Wrappers::JavaObjectHelper::JObjectToJWrapper(motionEvent, true);
...
void JNICALL callUno_Fuse_Android_StatusBarConfig_UpdateStatusBar359(JNIEnv *env,jclass clazz)
{
    uAutoReleasePool pool;
    INIT_JNI;
    JTRY
...
void JNICALL callUno_Fuse_Controls_Native_Android_FocusChangedListener_OnFocusChange127(JNIEnv *env,jclass clazz,jobject jthis,jboolean hasFocus)
{
    uAutoReleasePool pool;
    INIT_JNI;
...
void JNICALL callUno_Fuse_Controls_Native_Android_Slider_OnSeekBarChanged178(JNIEnv *env,jclass clazz,jobject jthis,jdouble newProgress)
{
    uAutoReleasePool pool;
    INIT_JNI;
...
void JNICALL callUno_Fuse_Controls_VideoImpl_Android_MediaPlayer_OnBuffer264(JNIEnv *env,jclass clazz,jobject jthis,jint percent)
{
    uAutoReleasePool pool;
    INIT_JNI;
...
void JNICALL callUno_Fuse_Controls_VideoImpl_Android_MediaPlayer_OnCompletion262(JNIEnv *env,jclass clazz,jobject jthis)
{
    uAutoReleasePool pool;
    INIT_JNI;
    ::g::Fuse::Controls::VideoImpl::Android::MediaPlayer* uno_jthis = uCast<::g::Fuse::Controls::VideoImpl::Android::MediaPlayer*>(::g::Uno::Compiler::ExportTargetInterop::Foreign::Android::JavaUnoObject::UnBox(jthis), ::g::Fuse::Controls::VideoImpl::Android::MediaPlayer_typeof());
...
void JNICALL callUno_Fuse_Controls_VideoImpl_Android_MediaPlayer_OnError263(JNIEnv *env,jclass clazz,jobject jthis,jint what,jint extra)
{
    uAutoReleasePool pool;
    INIT_JNI;
    ::g::Fuse::Controls::VideoImpl::Android::MediaPlayer* uno_jthis = uCast<::g::Fuse::Controls::VideoImpl::Android::MediaPlayer*>(::g::Uno::Compiler::ExportTargetInterop::Foreign::Android::JavaUnoObject::UnBox(jthis), ::g::Fuse::Controls::VideoImpl::Android::MediaPlayer_typeof());
...
void JNICALL callUno_Fuse_Controls_VideoImpl_Android_MediaPlayer_OnErrorOccurred276(JNIEnv *env,jclass clazz,jobject jthis,jobject msg)
{
    uAutoReleasePool pool;
    INIT_JNI;
    ::g::Fuse::Controls::VideoImpl::Android::MediaPlayer* uno_jthis = uCast<::g::Fuse::Controls::VideoImpl::Android::MediaPlayer*>(::g::Uno::Compiler::ExportTargetInterop::Foreign::Android::JavaUnoObject::UnBox(jthis), ::g::Fuse::Controls::VideoImpl::Android::MediaPlayer_typeof());
...
void JNICALL callUno_Fuse_Controls_VideoImpl_Android_MediaPlayer_OnFrameAvailable267(JNIEnv *env,jclass clazz,jobject jthis)
{
    uAutoReleasePool pool;
    INIT_JNI;
    ::g::Fuse::Controls::VideoImpl::Android::MediaPlayer* uno_jthis = uCast<::g::Fuse::Controls::VideoImpl::Android::MediaPlayer*>(::g::Uno::Compiler::ExportTargetInterop::Foreign::Android::JavaUnoObject::UnBox(jthis), ::g::Fuse::Controls::VideoImpl::Android::MediaPlayer_typeof());
...
void JNICALL callUno_Fuse_Controls_VideoImpl_Android_MediaPlayer_OnPrepared261(JNIEnv *env,jclass clazz,jobject jthis)
{
    uAutoReleasePool pool;
    INIT_JNI;
    ::g::Fuse::Controls::VideoImpl::Android::MediaPlayer* uno_jthis = uCast<::g::Fuse::Controls::VideoImpl::Android::MediaPlayer*>(::g::Uno::Compiler::ExportTargetInterop::Foreign::Android::JavaUnoObject::UnBox(jthis), ::g::Fuse::Controls::VideoImpl::Android::MediaPlayer_typeof());
...
void JNICALL callUno_Fuse_Internal_AndroidSystemFont_AddAlias117(JNIEnv *env,jclass clazz,jobject name,jobject to,jint weight)
{
    uAutoReleasePool pool;
    INIT_JNI;
...
void JNICALL callUno_Fuse_Internal_AndroidSystemFont_AddFamily115(JNIEnv *env,jclass clazz,jobject name,jobject language,jobject variant)
{
    uAutoReleasePool pool;
    INIT_JNI;
    uString* uno_name = JniHelper::JavaToUnoString((jstring)name);
...
void JNICALL callUno_Fuse_Internal_AndroidSystemFont_AddFont116(JNIEnv *env,jclass clazz,jobject path,jint index,jint weight,jboolean isItalic)
{
    uAutoReleasePool pool;
    INIT_JNI;
...
void JNICALL callUno_Fuse_Internal_AndroidSystemFont_ThrowUno118(JNIEnv *env,jclass clazz,jobject message)
{
    uAutoReleasePool pool;
    INIT_JNI;
...
void JNICALL callUno_Fuse_Platform_SystemUI_cachedOpenSizeSet95(JNIEnv *env,jclass clazz,jint setVal)
{
    uAutoReleasePool pool;
    INIT_JNI;
    int uno_setVal = (int)setVal;
...
void JNICALL callUno_Fuse_Platform_SystemUI_cppOnConfigChanged103(JNIEnv *env,jclass clazz)
{
    uAutoReleasePool pool;
    INIT_JNI;
    JTRY
...
void JNICALL callUno_Fuse_Platform_SystemUI_firstSizingSet111(JNIEnv *env,jclass clazz,jboolean setVal)
{
    uAutoReleasePool pool;
    INIT_JNI;
...
void JNICALL callUno_Fuse_Platform_SystemUI_hasCachedStatusBarSizeSet94(JNIEnv *env,jclass clazz,jboolean setVal)
{
    uAutoReleasePool pool;
    INIT_JNI;
    bool uno_setVal = (bool)setVal;
...
void JNICALL callUno_Fuse_Platform_SystemUI_OnConfigChanged101(JNIEnv *env,jclass clazz)
{
    uAutoReleasePool pool;
    INIT_JNI;
    JTRY
...
void JNICALL callUno_Fuse_Platform_SystemUI_OnDestroy100(JNIEnv *env,jclass clazz)
{
    uAutoReleasePool pool;
    INIT_JNI;
    JTRY
...
void JNICALL callUno_Fuse_Platform_SystemUI_onHideKeyboard112(JNIEnv *env,jclass clazz,jint keyboardHeight,jboolean force)
{
    uAutoReleasePool pool;
    INIT_JNI;
...
void JNICALL callUno_Fuse_Platform_SystemUI_onShowKeyboard113(JNIEnv *env,jclass clazz,jint keyboardHeight,jboolean force)
{
    uAutoReleasePool pool;
    INIT_JNI;
    int uno_keyboardHeight = (int)keyboardHeight;
...
void JNICALL callUno_Fuse_Platform_SystemUI_ResendFrameSizes104(JNIEnv *env,jclass clazz)
{
    uAutoReleasePool pool;
    INIT_JNI;
    JTRY
...
void JNICALL callUno_Fuse_Platform_SystemUI_UpdateStatusBar107(JNIEnv *env,jclass clazz)
{
    uAutoReleasePool pool;
    INIT_JNI;
    JTRY
...
void JNICALL callUno_Neovisionaries_WebSocketClient__webSocketSet434(JNIEnv *env,jclass clazz,jobject jthis,jobject setVal,jlong setValPtr)
{
    uAutoReleasePool pool;
    INIT_JNI;
    ::g::Neovisionaries::WebSocketClient* uno_jthis = uCast<::g::Neovisionaries::WebSocketClient*>(::g::Uno::Compiler::ExportTargetInterop::Foreign::Android::JavaUnoObject::UnBox(jthis), ::g::Neovisionaries::WebSocketClient_typeof());
...
void JNICALL callUno_QreaderImpl_Cancelled452(JNIEnv *env,jclass clazz)
{
    uAutoReleasePool pool;
    INIT_JNI;
    JTRY
...
void JNICALL callUno_QreaderImpl_Picked451(JNIEnv *env,jclass clazz,jobject result)
{
    uAutoReleasePool pool;
    INIT_JNI;
...
// C:\Users\q\AppData\Local\Fusetools\Packages\UnoCore\1.3.1\Source\Uno\Compiler\ExportTargetInterop\Foreign\Android\ExternBlockHost.uno
// -------------------------------------------------------------------------------------------------------------------------------------
...
void ExternBlockHost::RegisterFunctions()
{
    ...
    {(char* const)"callUno_Android_ActivityUtils_OnReceived68", (char* const)"(IILjava/lang/Object;J)Z", (void *)&callUno_Android_ActivityUtils_OnReceived68},
    ...
    {(char* const)"callUno_Fuse_Platform_SystemUI_hasCachedStatusBarSizeGet94", (char* const)"()Z", (void *)&callUno_Fuse_Platform_SystemUI_hasCachedStatusBarSizeGet94},
    {(char* const)"callUno_Fuse_Platform_SystemUI_cachedOpenSizeGet95", (char* const)"()I", (void *)&callUno_Fuse_Platform_SystemUI_cachedOpenSizeGet95},
    {(char* const)"callUno_Fuse_Platform_SystemUI_hasCachedStatusBarSizeSet94", (char* const)"(Z)V", (void *)&callUno_Fuse_Platform_SystemUI_hasCachedStatusBarSizeSet94},
    {(char* const)"callUno_Fuse_Platform_SystemUI_cachedOpenSizeSet95", (char* const)"(I)V", (void *)&callUno_Fuse_Platform_SystemUI_cachedOpenSizeSet95},
    {(char* const)"callUno_Fuse_Platform_SystemUI_OnDestroy100", (char* const)"()V", (void *)&callUno_Fuse_Platform_SystemUI_OnDestroy100},
    {(char* const)"callUno_Fuse_Platform_SystemUI_OnConfigChanged101", (char* const)"()V", (void *)&callUno_Fuse_Platform_SystemUI_OnConfigChanged101},
    {(char* const)"callUno_Fuse_Platform_SystemUI_GetRealDisplayWidth102", (char* const)"()I", (void *)&callUno_Fuse_Platform_SystemUI_GetRealDisplayWidth102},
    {(char* const)"callUno_Fuse_Platform_SystemUI_cppOnConfigChanged103", (char* const)"()V", (void *)&callUno_Fuse_Platform_SystemUI_cppOnConfigChanged103},
    {(char* const)"callUno_Fuse_Platform_SystemUI_ResendFrameSizes104", (char* const)"()V", (void *)&callUno_Fuse_Platform_SystemUI_ResendFrameSizes104},
    ...
    {(char* const)"callUno_Fuse_Platform_SystemUI_UpdateStatusBar107", (char* const)"()V", (void *)&callUno_Fuse_Platform_SystemUI_UpdateStatusBar107},
    {(char* const)"callUno_Fuse_Platform_SystemUI_lastKeyboardHeightGet110", (char* const)"()I", (void *)&callUno_Fuse_Platform_SystemUI_lastKeyboardHeightGet110},
    {(char* const)"callUno_Fuse_Platform_SystemUI_firstSizingGet111", (char* const)"()Z", (void *)&callUno_Fuse_Platform_SystemUI_firstSizingGet111},
    {(char* const)"callUno_Fuse_Platform_SystemUI_onHideKeyboard112", (char* const)"(IZ)V", (void *)&callUno_Fuse_Platform_SystemUI_onHideKeyboard112},
    {(char* const)"callUno_Fuse_Platform_SystemUI_onShowKeyboard113", (char* const)"(IZ)V", (void *)&callUno_Fuse_Platform_SystemUI_onShowKeyboard113},
    {(char* const)"callUno_Fuse_Platform_SystemUI_firstSizingSet111", (char* const)"(Z)V", (void *)&callUno_Fuse_Platform_SystemUI_firstSizingSet111},
    {(char* const)"callUno_Fuse_Internal_AndroidSystemFont_AddFamily115", (char* const)"(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V", (void *)&callUno_Fuse_Internal_AndroidSystemFont_AddFamily115},
    {(char* const)"callUno_Fuse_Internal_AndroidSystemFont_AddFont116", (char* const)"(Ljava/lang/String;IIZ)V", (void *)&callUno_Fuse_Internal_AndroidSystemFont_AddFont116},
    {(char* const)"callUno_Fuse_Internal_AndroidSystemFont_AddAlias117", (char* const)"(Ljava/lang/String;Ljava/lang/String;I)V", (void *)&callUno_Fuse_Internal_AndroidSystemFont_AddAlias117},
    {(char* const)"callUno_Fuse_Internal_AndroidSystemFont_ThrowUno118", (char* const)"(Ljava/lang/String;)V", (void *)&callUno_Fuse_Internal_AndroidSystemFont_ThrowUno118},
    ...
    {(char* const)"callUno_Fuse_Controls_Native_Android_FocusChangedListener_OnFocusChange127", (char* const)"(Lcom/uno/UnoObject;Z)V", (void *)&callUno_Fuse_Controls_Native_Android_FocusChangedListener_OnFocusChange127},
    ...
    {(char* const)"callUno_Fuse_Controls_Native_Android_Slider_OnSeekBarChanged178", (char* const)"(Lcom/uno/UnoObject;D)V", (void *)&callUno_Fuse_Controls_Native_Android_Slider_OnSeekBarChanged178},
    ...
    {(char* const)"callUno_Fuse_Controls_Native_ViewHandle_NativeHandleGet239", (char* const)"(Lcom/uno/UnoObject;)Ljava/lang/Object;", (void *)&callUno_Fuse_Controls_Native_ViewHandle_NativeHandleGet239},
    {(char* const)"callUno_Fuse_Controls_VideoImpl_Android_MediaPlayer_OnPrepared261", (char* const)"(Lcom/uno/UnoObject;)V", (void *)&callUno_Fuse_Controls_VideoImpl_Android_MediaPlayer_OnPrepared261},
    {(char* const)"callUno_Fuse_Controls_VideoImpl_Android_MediaPlayer_OnCompletion262", (char* const)"(Lcom/uno/UnoObject;)V", (void *)&callUno_Fuse_Controls_VideoImpl_Android_MediaPlayer_OnCompletion262},
    {(char* const)"callUno_Fuse_Controls_VideoImpl_Android_MediaPlayer_OnError263", (char* const)"(Lcom/uno/UnoObject;II)V", (void *)&callUno_Fuse_Controls_VideoImpl_Android_MediaPlayer_OnError263},
    {(char* const)"callUno_Fuse_Controls_VideoImpl_Android_MediaPlayer_OnBuffer264", (char* const)"(Lcom/uno/UnoObject;I)V", (void *)&callUno_Fuse_Controls_VideoImpl_Android_MediaPlayer_OnBuffer264},
    {(char* const)"callUno_Fuse_Controls_VideoImpl_Android_MediaPlayer_OnFrameAvailable267", (char* const)"(Lcom/uno/UnoObject;)V", (void *)&callUno_Fuse_Controls_VideoImpl_Android_MediaPlayer_OnFrameAvailable267},
    {(char* const)"callUno_Fuse_Controls_VideoImpl_Android_MediaPlayer_OnErrorOccurred276", (char* const)"(Lcom/uno/UnoObject;Ljava/lang/String;)V", (void *)&callUno_Fuse_Controls_VideoImpl_Android_MediaPlayer_OnErrorOccurred276},
    {(char* const)"callUno_Uno_IO_BundleFile_BundlePathGet319", (char* const)"(Lcom/uno/UnoObject;)Ljava/lang/String;", (void *)&callUno_Uno_IO_BundleFile_BundlePathGet319},
    ...
    {(char* const)"callUno_Fuse_Android_AppRoot_OnTouchEvent__337", (char* const)"(Ljava/lang/Object;J)V", (void *)&callUno_Fuse_Android_AppRoot_OnTouchEvent__337},
    {(char* const)"callUno_Fuse_Android_StatusBarConfig_UpdateStatusBar359", (char* const)"()V", (void *)&callUno_Fuse_Android_StatusBarConfig_UpdateStatusBar359},
    ...
    {(char* const)"callUno_Neovisionaries_WebSocketClient__webSocketGet434", (char* const)"(Lcom/uno/UnoObject;)Ljava/lang/Object;", (void *)&callUno_Neovisionaries_WebSocketClient__webSocketGet434},
    ...
    {(char* const)"callUno_Neovisionaries_WebSocketClient__webSocketSet434", (char* const)"(Lcom/uno/UnoObject;Ljava/lang/Object;J)V", (void *)&callUno_Neovisionaries_WebSocketClient__webSocketSet434},
    {(char* const)"callUno_QreaderImpl_RC_BARCODE_CAPTUREGet450", (char* const)"()I", (void *)&callUno_QreaderImpl_RC_BARCODE_CAPTUREGet450},
    {(char* const)"callUno_QreaderImpl_Picked451", (char* const)"(Ljava/lang/String;)V", (void *)&callUno_QreaderImpl_Picked451},
    {(char* const)"callUno_QreaderImpl_Cancelled452", (char* const)"()V", (void *)&callUno_QreaderImpl_Cancelled452},
    };
    int funcCount = 131;
...
// C:\Users\q\AppData\Local\Fusetools\Packages\UnoCore\1.3.1\Source\Uno\Compiler\ExportTargetInterop\Foreign\Android\UnoArrayEntrypoints.uno
// -----------------------------------------------------------------------------------------------------------------------------------------
...
// C:\Users\q\AppData\Local\Fusetools\Packages\UnoCore\1.3.1\Source\Uno\Compiler\ExportTargetInterop\Foreign\Android\JavaUnoObject.uno
// -----------------------------------------------------------------------------------------------------------------------------------
