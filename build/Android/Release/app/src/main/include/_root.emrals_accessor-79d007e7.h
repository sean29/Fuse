...
struct emrals_accessor_SelectableRectangle_ID : ::g::Uno::UX::PropertyAccessor
{
    ...
    static ::g::Uno::UX::Selector& _name() { return emrals_accessor_SelectableRectangle_ID_typeof()->Init(), _name_; }
    static uSStrong< ::g::Uno::UX::PropertyAccessor*> Singleton_;
    static uSStrong< ::g::Uno::UX::PropertyAccessor*>& Singleton() { return emrals_accessor_SelectableRectangle_ID_typeof()->Init(), Singleton_; }
