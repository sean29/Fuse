...
{
    MainView__Template10::__selector0_ = ::g::Uno::UX::Selector__op_Implicit(::STRINGS[0/*"ecanthanks"*/]);
}

static void MainView__Template10_build(uType* type)
{
    ::STRINGS[0] = uString::Const("ecanthanks");
    type->SetFields(2,
...
{
    ::g::EcanThankYouPage* __self1 = ::g::EcanThankYouPage::New5(uPtr(__this->__parent1)->router);
...
{
    ctor_(::STRINGS[0/*"ecanthanks"*/], false);
    __parent1 = parent;
