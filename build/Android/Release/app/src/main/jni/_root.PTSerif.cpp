// This file was generated based on '.uno/ux13/PTSerif.g.uno'.
...
// public partial sealed class PTSerif :2
// {
// static PTSerif() :4
static void PTSerif__cctor_4_fn(uType* __type)
{
}

static void PTSerif_build(uType* type)
{
    type->SetInterfaces(
...
::g::Fuse::Controls::TextControl_type* PTSerif_typeof()
{
    ...
    options.ObjectSize = sizeof(PTSerif);
    options.TypeSize = sizeof(::g::Fuse::Controls::TextControl_type);
    type = (::g::Fuse::Controls::TextControl_type*)uClassType::New("PTSerif", options);
    type->fp_build_ = PTSerif_build;
    type->fp_ctor_ = (void*)PTSerif__New4_fn;
    type->fp_cctor_ = PTSerif__cctor_4_fn;
...
// public PTSerif() :8
void PTSerif__ctor_8_fn(PTSerif* __this)
{
    __this->ctor_8();
}

// private void InitializeUX() :12
void PTSerif__InitializeUX1_fn(PTSerif* __this)
{
    __this->InitializeUX1();
}

// public PTSerif New() :8
void PTSerif__New4_fn(PTSerif** __retval)
{
    *__retval = PTSerif::New4();
}

// public PTSerif() [instance] :8
void PTSerif::ctor_8()
{
    ctor_7();
    InitializeUX1();
...
void PTSerif::InitializeUX1()
{
    FontSize(20.0f);
    Color(::g::Uno::Float4__New2(0.3882353f, 0.3882353f, 0.3921569f, 1.0f));
    Font(::g::CameraPage::PTSerif());
}

// public PTSerif New() [static] :8
PTSerif* PTSerif::New4()
{
    PTSerif* obj1 = (PTSerif*)uNew(PTSerif_typeof());
    obj1->ctor_8();
    return obj1;
}
// }
