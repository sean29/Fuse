...
namespace g{struct emrals_MyLoadingIndicator3_ThemeColor_Property;}
...
struct emrals_MyLoadingIndicator3_ThemeColor_Property : ::g::Uno::UX::Property1
{
    uWeak< ::g::MyLoadingIndicator3*> _obj;

    void ctor_3(::g::MyLoadingIndicator3* obj, ::g::Uno::UX::Selector name);
    static emrals_MyLoadingIndicator3_ThemeColor_Property* New1(::g::MyLoadingIndicator3* obj, ::g::Uno::UX::Selector name);
};
// }
