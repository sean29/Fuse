// This file was generated based on '.uno/ux13/Dog.g.uno'.
...
// {
// static Dog() :4
static void Dog__cctor_4_fn(uType* __type)
{
}

static void Dog_build(uType* type)
{
    type->SetInterfaces(
...
::g::Fuse::Controls::TextControl_type* Dog_typeof()
{
    ...
    options.ObjectSize = sizeof(Dog);
    options.TypeSize = sizeof(::g::Fuse::Controls::TextControl_type);
    type = (::g::Fuse::Controls::TextControl_type*)uClassType::New("Dog", options);
    type->fp_build_ = Dog_build;
    type->fp_ctor_ = (void*)Dog__New4_fn;
    type->fp_cctor_ = Dog__cctor_4_fn;
...
// public Dog New() [static] :8
Dog* Dog::New4()
{
    Dog* obj1 = (Dog*)uNew(Dog_typeof());
    obj1->ctor_8();
    return obj1;
}
// }
