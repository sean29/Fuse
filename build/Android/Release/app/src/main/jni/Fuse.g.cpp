...
{
    {
        ...
        WITH_STATIC_JAVA_METHOD(__mtd, __cls, "GetReleaseVersion433", "()Ljava/lang/String;");
...
void DrawContext::ReleaseRootbuffer()
{
    if (uPtr(_glScissors)->Count() > 0)
        ::g::Fuse::Diagnostics::InternalError(::STRINGS[33/*"Unpopped Sc...*/], this, ::STRINGS[3/*"/usr/local/...*/], 609, ::STRINGS[34/*"ReleaseRoot...*/]);

    uPtr(_glScissors)->Clear();

    if (uPtr(_cullFaces)->Count() > 0)
        ::g::Fuse::Diagnostics::InternalError(::STRINGS[35/*"Unpopped Cu...*/], this, ::STRINGS[3/*"/usr/local/...*/], 613, ::STRINGS[34/*"ReleaseRoot...*/]);

    uPtr(_cullFaces)->Clear();

    if (uPtr(_viewports)->Count() > 0)
        ::g::Fuse::Diagnostics::InternalError(::STRINGS[36/*"Unpopped Vi...*/], this, ::STRINGS[3/*"/usr/local/...*/], 617, ::STRINGS[34/*"ReleaseRoot...*/]);

    uPtr(_viewports)->Clear();

    if (uPtr(_renderTargets)->Count() > 0)
        ::g::Fuse::Diagnostics::InternalError(::STRINGS[37/*"Unpopped Re...*/], this, ::STRINGS[3/*"/usr/local/...*/], 621, ::STRINGS[34/*"ReleaseRoot...*/]);
...
static void GraphicsWorker_build(uType* type)
{
    ...
    ::STRINGS[49] = uString::Const("/usr/local/share/uno/Packages/Fuse.Common/1.2.1/$.uno");
...
void GraphicsWorker::Run()
{
    ...
    while (!GraphicsWorker::_terminating())
    {
        ...
        if ((::g::Uno::Threading::ConcurrentQueue__TryDequeue_fn(uPtr(GraphicsWorker::_work()), (void**)(&a), &ret2), ret2))
        {
            ...
            {
                ::g::Uno::Exception* e = __t.Exception;
                ::g::Fuse::Diagnostics::UnknownException(::STRINGS[48/*"GraphicsWor...*/], e, a, ::STRINGS[49/*"/usr/local/...*/], 2197, ::STRINGS[50/*"Run"*/]);
...
static void Marshal_build(uType* type)
{
    ...
    ::STRINGS[11] = uString::Const("'");
    ::STRINGS[69] = uString::Const("/usr/local/share/uno/Packages/Fuse.Marshal/1.2.1/$.uno");
...
bool Marshal::TryConvertTo(uType* t, uObject* o, uObject** res, uObject* diagnosticSource)
{
    ...
    if (diagnosticSource != NULL)
        ::g::Fuse::Diagnostics::UserError(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition1(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition1(::STRINGS[67/*"Cannot conv...*/], o), ::STRINGS[68/*"' to target...*/]), t), ::STRINGS[11/*"'"*/]), diagnosticSource, ::STRINGS[69/*"/usr/local/...*/], 746, ::STRINGS[70/*"TryConvertTo"*/], NULL);
...
void NodeGroupBase::AddContent()
{
    ...
    if (Parent() == NULL)
    {
        ::g::Fuse::Diagnostics::InternalError(::STRINGS[82/*"AddContent ...*/], this, ::STRINGS[3/*"/usr/local/...*/], 3285, ::STRINGS[83/*"AddContent"*/]);
        return;
    }
    ...
    if (where == -1)
    {
        ::g::Fuse::Diagnostics::InternalError(::STRINGS[84/*"Could not l...*/], this, ::STRINGS[3/*"/usr/local/...*/], 3304, ::STRINGS[83/*"AddContent"*/]);
        return;
    }
    ...
    if (_useTemplates)
        ...
        for (int i2 = 0; i2 < _templates.Count(); ++i2)
        {
            ...
            if (n1 == NULL)
            {
                ::g::Fuse::Diagnostics::InternalError(::STRINGS[85/*"Template co...*/], this, ::STRINGS[3/*"/usr/local/...*/], 3326, ::STRINGS[83/*"AddContent"*/]);
...
static void UserEvent_build(uType* type)
{
    ...
    ::STRINGS[95] = uString::Const("/usr/local/share/uno/Packages/Fuse.UserEvents/1.2.1/$.uno");
...
void UserEvent__OnRooted_fn(UserEvent* __this)
{
    ...
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[94/*"UserEvent r...*/], __this, ::STRINGS[95/*"/usr/local/...*/], 654, ::STRINGS[96/*"OnRooted"*/], NULL);
        return;
    }
...
void UserEvent::Raise(::g::Uno::Collections::Dictionary* args)
{
    if (Dispatch == NULL)
    {
        ::g::Fuse::Diagnostics::InternalError(::STRINGS[99/*"Trying to R...*/], this, ::STRINGS[95/*"/usr/local/...*/], 701, ::STRINGS[100/*"Raise"*/]);
        return;
    }
...
void UserEvent::raise(::g::Fuse::Scripting::Context* c, UserEvent* n, uArray* args)
{
    ...
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[97/*"Raise must ...*/], n, ::STRINGS[95/*"/usr/local/...*/], 421, ::STRINGS[93/*"raise"*/], NULL);
        return;
    }
    ...
    if (so == NULL)
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[98/*"Raise must ...*/], uPtr(args)->Strong<uObject*>(0), ::STRINGS[95/*"/usr/local/...*/], 428, ::STRINGS[93/*"raise"*/], NULL);
        return;
    }
