...
// C:\Users\q\AppData\Local\Fusetools\Packages\Fuse.Elements\1.3.0-rc2\Enums.uno
// -----------------------------------------------------------------------------
...
// C:\Users\q\AppData\Local\Fusetools\Packages\Fuse.Elements\1.3.0-rc2\Element.Transform.uno
// -----------------------------------------------------------------------------------------
...
// C:\Users\q\AppData\Local\Fusetools\Packages\Fuse.Elements\1.3.0-rc2\AspectBoxSizing.uno
// ---------------------------------------------------------------------------------------
...
// C:\Users\q\AppData\Local\Fusetools\Packages\Fuse.Elements\1.3.0-rc2\BoxSizing.uno
// ---------------------------------------------------------------------------------
...
// C:\Users\q\AppData\Local\Fusetools\Packages\Fuse.Elements\1.3.0-rc2\Caching\Cache.Heuristic.uno
// -----------------------------------------------------------------------------------------------
...
// C:\Users\q\AppData\Local\Fusetools\Packages\Fuse.Elements\1.3.0-rc2\Caching\Cache.uno
// -------------------------------------------------------------------------------------
...
// C:\Users\q\AppData\Local\Fusetools\Packages\Fuse.Elements\1.3.0-rc2\Caching\ElementAtlasPool.uno
// ------------------------------------------------------------------------------------------------
...
void Element__Draw_fn(Element* __this, ::g::Fuse::DrawContext* dc)
{
    if (!__this->IsRootingCompleted())
        ::g::Fuse::Diagnostics::InternalError(uString::Const("Draw called on a non-rooted node"), __this, uString::Const("C:\\Users\\q\\AppData\\Local\\Fusetools\\Packages\\Fuse.Elements\\1.3.0-rc2\\Element.Drawing.uno"), 67, uString::Const("Draw"));
...
void Element__OnArrangeMarginBox_fn(Element* __this, ::g::Uno::Float2* position, ::g::Fuse::LayoutParams* lp, ::g::Uno::Float2* __retval)
{
    ...
    if (bp.SanityConstrain())
    {
        if (!Element::_invalidValuesWarn_)
            ::g::Fuse::Diagnostics::InternalError(uString::Const("Invalid values in ArrangeMarginBox"), __this, uString::Const("C:\\Users\\q\\AppData\\Local\\Fusetools\\Packages\\Fuse.Elements\\1.3.0-rc2\\Element.Layout.uno"), 262, uString::Const("OnArrangeMarginBox"));
...
void Element::Composit(::g::Fuse::DrawContext* dc)
{
    ...
    if (!r && !_warnNoCacheDraw)
    {
        ...
        ::g::Fuse::Diagnostics::InternalError(uString::Const("This element can not be drawn."), this, uString::Const("C:\\Users\\q\\AppData\\Local\\Fusetools\\Packages\\Fuse.Elements\\1.3.0-rc2\\Element.Effects.uno"), 125, uString::Const("Composit"));
    }
}
...
// C:\Users\q\AppData\Local\Fusetools\Packages\Fuse.Elements\1.3.0-rc2\Caching\ElementAtlas.uno
// --------------------------------------------------------------------------------------------
...
// C:\Users\q\AppData\Local\Fusetools\Packages\Fuse.Elements\1.3.0-rc2\Caching\ElementBatch.uno
// --------------------------------------------------------------------------------------------
...
// C:\Users\q\AppData\Local\Fusetools\Packages\Fuse.Elements\1.3.0-rc2\Caching\ElementBatcher.uno
// ----------------------------------------------------------------------------------------------
...
// C:\Users\q\AppData\Local\Fusetools\Packages\Fuse.Elements\1.3.0-rc2\Element.Layout.uno
// --------------------------------------------------------------------------------------
...
// C:\Users\q\AppData\Local\Fusetools\Packages\Fuse.Elements\1.3.0-rc2\Element.HitTest.uno
// ---------------------------------------------------------------------------------------
...
// C:\Users\q\AppData\Local\Fusetools\Packages\Fuse.Elements\1.3.0-rc2\InteractiveTransform.uno
// --------------------------------------------------------------------------------------------
...
{
    ::g::Uno::UX::Selector_typeof()->Init();
    InteractiveTransform::_zoomFactorName_ = ::g::Uno::UX::Selector__op_Implicit(::STRINGS[10/*"ZoomFactor"*/]);
    InteractiveTransform::_rotationName_ = ::g::Uno::UX::Selector__op_Implicit(::STRINGS[11/*"Rotation"*/]);
    InteractiveTransform::_translationName_ = ::g::Uno::UX::Selector__op_Implicit(::STRINGS[12/*"Translation"*/]);
}

static void InteractiveTransform_build(uType* type)
{
    ::STRINGS[10] = uString::Const("ZoomFactor");
    ::STRINGS[11] = uString::Const("Rotation");
    ::STRINGS[12] = uString::Const("Translation");
    type->SetInterfaces(
...
// C:\Users\q\AppData\Local\Fusetools\Packages\Fuse.Elements\1.3.0-rc2\Element.ITreeRenderer.uno
// ---------------------------------------------------------------------------------------------
...
// C:\Users\q\AppData\Local\Fusetools\Packages\Fuse.Elements\1.3.0-rc2\LayoutMasterBoxSizing.uno
// ---------------------------------------------------------------------------------------------
...
// C:\Users\q\AppData\Local\Fusetools\Packages\Fuse.Elements\1.3.0-rc2\LimitBoxSizing.uno
// --------------------------------------------------------------------------------------
...
// C:\Users\q\AppData\Local\Fusetools\Packages\Fuse.Elements\1.3.0-rc2\Transforms.uno
// ----------------------------------------------------------------------------------
