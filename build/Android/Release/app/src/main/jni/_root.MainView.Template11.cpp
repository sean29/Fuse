...
{
    MainView__Template11::__selector0_ = ::g::Uno::UX::Selector__op_Implicit(::STRINGS[0/*"impactthanks"*/]);
}

static void MainView__Template11_build(uType* type)
{
    ::STRINGS[0] = uString::Const("impactthanks");
    type->SetFields(2,
...
{
    ::g::ImpactThankYouPage* __self1 = ::g::ImpactThankYouPage::New5(uPtr(__this->__parent1)->router);
...
{
    ctor_(::STRINGS[0/*"impactthanks"*/], false);
    __parent1 = parent;
