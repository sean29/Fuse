// This file was generated based on '.uno/ux11/SmallCog.g.uno'.
...
// public partial sealed class SmallCog :2
// {
// static SmallCog() :4
...
::g::Fuse::Controls::Control_type* SmallCog_typeof()
{
    ...
    type = (::g::Fuse::Controls::Control_type*)uClassType::New("SmallCog", options);
...
void SmallCog::InitializeUX1()
{
    ...
    File(::g::Uno::UX::BundleFileSource::New1(::g::emrals_bundle::cog1_whitecfce0759()));
}

// public SmallCog New() [static] :8
