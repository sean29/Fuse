// This file was generated based on '.uno/ux13/PTreal.g.uno'.
...
// public partial sealed class PTreal :2
// {
// static PTreal() :4
static void PTreal__cctor_4_fn(uType* __type)
{
}

static void PTreal_build(uType* type)
{
    type->SetInterfaces(
...
::g::Fuse::Controls::TextControl_type* PTreal_typeof()
{
    ...
    options.ObjectSize = sizeof(PTreal);
    options.TypeSize = sizeof(::g::Fuse::Controls::TextControl_type);
    type = (::g::Fuse::Controls::TextControl_type*)uClassType::New("PTreal", options);
    type->fp_build_ = PTreal_build;
    type->fp_ctor_ = (void*)PTreal__New4_fn;
    type->fp_cctor_ = PTreal__cctor_4_fn;
...
// public PTreal() :8
void PTreal__ctor_8_fn(PTreal* __this)
{
    __this->ctor_8();
}

// private void InitializeUX() :12
void PTreal__InitializeUX1_fn(PTreal* __this)
{
    __this->InitializeUX1();
}

// public PTreal New() :8
void PTreal__New4_fn(PTreal** __retval)
{
    *__retval = PTreal::New4();
}

// public PTreal() [instance] :8
void PTreal::ctor_8()
{
    ctor_7();
    InitializeUX1();
...
void PTreal::InitializeUX1()
{
    FontSize(20.0f);
    Color(::g::Uno::Float4__New2(0.3882353f, 0.3882353f, 0.3921569f, 1.0f));
    Font(::g::AlertsPage::PTreal());
}

// public PTreal New() [static] :8
PTreal* PTreal::New4()
{
    PTreal* obj1 = (PTreal*)uNew(PTreal_typeof());
    obj1->ctor_8();
    return obj1;
}
// }
