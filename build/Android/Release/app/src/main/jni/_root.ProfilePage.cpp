...
// {
// static ProfilePage() :19
static void ProfilePage__cctor_4_fn(uType* __type)
{
    ProfilePage::__g_static_nametable1_ = uArray::Init<uString*>(::TYPES[0/*string[]*/], 4, ::STRINGS[0/*"router"*/], ::STRINGS[1/*"temp_eb60"*/], ::STRINGS[2/*"temp_eb61"*/], ::STRINGS[3/*"temp_eb62"*/]);
    ProfilePage::__selector0_ = ::g::Uno::UX::Selector__op_Implicit(::STRINGS[4/*"Value"*/]);
    ProfilePage::__selector1_ = ::g::Uno::UX::Selector__op_Implicit(::STRINGS[5/*"Url"*/]);
    ProfilePage::__selector2_ = ::g::Uno::UX::Selector__op_Implicit(::STRINGS[6/*"Visibility"*/]);
}

static void ProfilePage_build(uType* type)
{
    ::STRINGS[0] = uString::Const("router");
    ::STRINGS[1] = uString::Const("temp_eb60");
    ::STRINGS[2] = uString::Const("temp_eb61");
    ::STRINGS[3] = uString::Const("temp_eb62");
    ::STRINGS[4] = uString::Const("Value");
    ::STRINGS[5] = uString::Const("Url");
    ::STRINGS[6] = uString::Const("Visibility");
    ::STRINGS[7] = uString::Const("back");
    ::STRINGS[8] = uString::Const("user_emrals");
    ::STRINGS[9] = uString::Const("user_xp");
    ::STRINGS[10] = uString::Const("user_avatar");
    ::STRINGS[11] = uString::Const("doLogout");
    ::STRINGS[12] = uString::Const("widget_visible");
    ::STRINGS[13] = uString::Const("goToLogin");
    ::STRINGS[14] = uString::Const("<<");
    ::STRINGS[15] = uString::Const("PROFILE");
    ::STRINGS[16] = uString::Const("50,50");
    ::STRINGS[17] = uString::Const("200,100");
    ::STRINGS[18] = uString::Const("Emrals");
    ::STRINGS[19] = uString::Const("XP");
    ::STRINGS[20] = uString::Const("LOG OUT");
    ...
    type->SetFields(111,
        ::g::Uno::UX::NameTable_typeof(), offsetof(::g::ProfilePage, __g_nametable1), 0,
        ::g::Fuse::Navigation::Router_typeof(), offsetof(::g::ProfilePage, router), 0,
        ::g::Fuse::Reactive::EventBinding_typeof(), offsetof(::g::ProfilePage, temp_eb60), 0,
        ::g::Fuse::Reactive::EventBinding_typeof(), offsetof(::g::ProfilePage, temp_eb61), 0,
        ::g::Fuse::Reactive::EventBinding_typeof(), offsetof(::g::ProfilePage, temp_eb62), 0,
        ::g::Uno::UX::Property1_typeof()->MakeType(::g::Uno::String_typeof(), NULL), offsetof(::g::ProfilePage, temp_Value_inst), 0,
        ::g::Uno::UX::Property1_typeof()->MakeType(::g::Uno::String_typeof(), NULL), offsetof(::g::ProfilePage, temp1_Value_inst), 0,
        ::g::Uno::UX::Property1_typeof()->MakeType(::g::Uno::String_typeof(), NULL), offsetof(::g::ProfilePage, temp2_Url_inst), 0,
        ::g::Uno::UX::Property1_typeof()->MakeType(::g::Fuse::Elements::Visibility_typeof(), NULL), offsetof(::g::ProfilePage, temp3_Visibility_inst), 0,
        ::TYPES[0/*string[]*/], (uintptr_t)&::g::ProfilePage::__g_static_nametable1_, uFieldFlagsStatic,
...
// public ProfilePage(Fuse.Navigation.Router router) :23
...
// public ProfilePage New(Fuse.Navigation.Router router) :23
...
// public ProfilePage(Fuse.Navigation.Router router) [instance] :23
...
{
    ::g::Fuse::Reactive::Data* temp4 = ::g::Fuse::Reactive::Data::New1(::STRINGS[7/*"back"*/]);
    __g_nametable1 = ::g::Uno::UX::NameTable::New1(NULL, ProfilePage::__g_static_nametable1());
    ::g::Mouse* temp = ::g::Mouse::New4();
    temp_Value_inst = ::g::emrals_FuseControlsTextControl_Value_Property::New1(temp, ProfilePage::__selector0());
    ::g::Fuse::Reactive::Data* temp5 = ::g::Fuse::Reactive::Data::New1(::STRINGS[8/*"user_emrals"*/]);
    ::g::Mouse* temp1 = ::g::Mouse::New4();
    temp1_Value_inst = ::g::emrals_FuseControlsTextControl_Value_Property::New1(temp1, ProfilePage::__selector0());
    ::g::Fuse::Reactive::Data* temp6 = ::g::Fuse::Reactive::Data::New1(::STRINGS[9/*"user_xp"*/]);
    ::g::Fuse::Drawing::ImageFill* temp2 = ::g::Fuse::Drawing::ImageFill::New2();
    temp2_Url_inst = ::g::emrals_FuseDrawingImageFill_Url_Property::New1(temp2, ProfilePage::__selector1());
    ::g::Fuse::Reactive::Data* temp7 = ::g::Fuse::Reactive::Data::New1(::STRINGS[10/*"user_avatar"*/]);
    ::g::Fuse::Reactive::Data* temp8 = ::g::Fuse::Reactive::Data::New1(::STRINGS[11/*"doLogout"*/]);
    ::g::Fuse::Controls::Rectangle* temp3 = ::g::Fuse::Controls::Rectangle::New3();
    temp3_Visibility_inst = ::g::emrals_FuseElementsElement_Visibility_Property::New1(temp3, ProfilePage::__selector2());
    ::g::Fuse::Reactive::Data* temp9 = ::g::Fuse::Reactive::Data::New1(::STRINGS[12/*"widget_visi...*/]);
    ::g::Fuse::Reactive::Data* temp10 = ::g::Fuse::Reactive::Data::New1(::STRINGS[13/*"goToLogin"*/]);
    ::g::Fuse::Controls::Panel* temp11 = ::g::Fuse::Controls::Panel::New3();
    ::g::Fuse::Controls::Text* temp12 = ::g::Fuse::Controls::Text::New3();
    temp_eb60 = ::g::Fuse::Reactive::EventBinding::New1((uObject*)temp4, __g_nametable1);
    ...
    ::g::Fuse::Reactive::DataBinding* temp23 = ::g::Fuse::Reactive::DataBinding::New1(temp1_Value_inst, (uObject*)temp6, __g_nametable1, 3);
    ...
    ::g::Fuse::Reactive::DataBinding* temp27 = ::g::Fuse::Reactive::DataBinding::New1(temp2_Url_inst, (uObject*)temp7, __g_nametable1, 3);
    ::g::Fuse::Controls::Text* temp28 = ::g::Fuse::Controls::Text::New3();
    temp_eb61 = ::g::Fuse::Reactive::EventBinding::New1((uObject*)temp8, __g_nametable1);
    ::g::Fuse::Reactive::DataBinding* temp29 = ::g::Fuse::Reactive::DataBinding::New1(temp3_Visibility_inst, (uObject*)temp9, __g_nametable1, 3);
    ::g::Fuse::Controls::Rectangle* temp30 = ::g::Fuse::Controls::Rectangle::New3();
    ::g::Fuse::Controls::Text* temp31 = ::g::Fuse::Controls::Text::New3();
    temp_eb62 = ::g::Fuse::Reactive::EventBinding::New1((uObject*)temp10, __g_nametable1);
    ...
    ::g::Fuse::Gestures::Clicked::AddHandler(temp12, uDelegate::New(::TYPES[2/*Fuse.Gestures.ClickedHandler*/], (void*)::g::Fuse::Reactive::EventBinding__OnEvent_fn, uPtr(temp_eb60)));
    ::g::Uno::Collections::ICollection::Add_ex(uInterface(uPtr(temp12->Bindings()), ::TYPES[3/*Uno.Collections.ICollection<Fuse.Binding>*/]), temp_eb60);
    temp13->Value(::STRINGS[15/*"PROFILE"*/]);
    temp13->Alignment(10);
    ...
    ::g::Uno::Collections::ICollection::Add_ex(uInterface(uPtr(temp15->Children()), ::TYPES[1/*Uno.Collections.ICollection<Fuse.Node>*/]), temp24);
    ::g::Uno::Collections::ICollection::Add_ex(uInterface(uPtr(temp15->Children()), ::TYPES[1/*Uno.Collections.ICollection<Fuse.Node>*/]), temp3);
    ::g::Uno::Collections::ICollection::Add_ex(uInterface(uPtr(temp15->Children()), ::TYPES[1/*Uno.Collections.ICollection<Fuse.Node>*/]), temp30);
    ...
    temp19->Rows(::STRINGS[16/*"50,50"*/]);
    temp19->Columns(::STRINGS[17/*"200,100"*/]);
    temp19->Alignment(10);
    ...
    temp20->Value(::STRINGS[18/*"Emrals"*/]);
    ...
    ::g::Uno::Collections::ICollection::Add_ex(uInterface(uPtr(temp26->Fills()), ::TYPES[4/*Uno.Collections.ICollection<Fuse.Drawing.Brush>*/]), temp2);
    ::g::Uno::Collections::ICollection::Add_ex(uInterface(uPtr(temp26->Bindings()), ::TYPES[3/*Uno.Collections.ICollection<Fuse.Binding>*/]), temp27);
    temp2->WrapMode(1);
    ...
    ::g::Fuse::Gestures::Clicked::AddHandler(temp3, uDelegate::New(::TYPES[2/*Fuse.Gestures.ClickedHandler*/], (void*)::g::Fuse::Reactive::EventBinding__OnEvent_fn, uPtr(temp_eb61)));
    ::g::Uno::Collections::ICollection::Add_ex(uInterface(uPtr(temp3->Children()), ::TYPES[1/*Uno.Collections.ICollection<Fuse.Node>*/]), temp28);
    ::g::Uno::Collections::ICollection::Add_ex(uInterface(uPtr(temp3->Bindings()), ::TYPES[3/*Uno.Collections.ICollection<Fuse.Binding>*/]), temp_eb61);
    ...
    temp28->Value(::STRINGS[20/*"LOG OUT"*/]);
    ...
    ::g::Fuse::Gestures::Clicked::AddHandler(temp30, uDelegate::New(::TYPES[2/*Fuse.Gestures.ClickedHandler*/], (void*)::g::Fuse::Reactive::EventBinding__OnEvent_fn, uPtr(temp_eb62)));
    ...
    ::g::Uno::Collections::ICollection::Add_ex(uInterface(uPtr(temp30->Bindings()), ::TYPES[3/*Uno.Collections.ICollection<Fuse.Binding>*/]), temp_eb62);
    temp31->Value(::STRINGS[21/*"LOG IN"*/]);
    ...
    ::g::Uno::Collections::ICollection::Add_ex(uInterface(uPtr(uPtr(__g_nametable1)->Objects()), ::TYPES[5/*Uno.Collections.ICollection<object>*/]), temp_eb60);
    ::g::Uno::Collections::ICollection::Add_ex(uInterface(uPtr(uPtr(__g_nametable1)->Objects()), ::TYPES[5/*Uno.Collections.ICollection<object>*/]), temp_eb61);
    ::g::Uno::Collections::ICollection::Add_ex(uInterface(uPtr(uPtr(__g_nametable1)->Objects()), ::TYPES[5/*Uno.Collections.ICollection<object>*/]), temp_eb62);
...
// public ProfilePage New(Fuse.Navigation.Router router) [static] :23
