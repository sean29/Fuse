// This file was generated based on '.uno/ux13/Name.g.uno'.
...
{
    ::g::Fuse::Font* temp = ::g::Fuse::Font::New2(::g::Uno::UX::BundleFileSource::New1(::g::emrals_bundle::RobotoBoldf39291cd()));
    FontSize(15.0f);
    Font(temp);
}
