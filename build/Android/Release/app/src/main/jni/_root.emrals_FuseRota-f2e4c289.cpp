...
// internal sealed class emrals_FuseRotation_Degrees_Property :175
// {
static void emrals_FuseRotation_Degrees_Property_build(uType* type)
{
    ...
    type->SetFields(1,
        ::TYPES[0/*Fuse.Rotation*/], offsetof(::g::emrals_FuseRotation_Degrees_Property, _obj), uFieldFlagsWeak);
}
...
// public emrals_FuseRotation_Degrees_Property(Fuse.Rotation obj, Uno.UX.Selector name) :178
...
// public emrals_FuseRotation_Degrees_Property New(Fuse.Rotation obj, Uno.UX.Selector name) :178
...
// public emrals_FuseRotation_Degrees_Property(Fuse.Rotation obj, Uno.UX.Selector name) [instance] :178
...
// public emrals_FuseRotation_Degrees_Property New(Fuse.Rotation obj, Uno.UX.Selector name) [static] :178
