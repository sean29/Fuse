...
{
    AlertsPage__Template::__g_static_nametable1_ = uArray::Init<uString*>(::TYPES[0/*string[]*/], 1, ::STRINGS[0/*"temp_eb16"*/]);
...
{
    ::STRINGS[0] = uString::Const("temp_eb16");
    ...
    ::STRINGS[6] = uString::Const("solution_pending");
    ...
    type->SetFields(2,
        ...
        ::g::Uno::UX::Property1_typeof()->MakeType(::g::Uno::String_typeof(), NULL), offsetof(::g::AlertsPage__Template, temp3_Value_inst), 0,
...
void AlertsPage__Template__New1_fn(AlertsPage__Template* __this, uObject** __retval)
{
    ...
    ::g::Fuse::Reactive::Data* temp5 = ::g::Fuse::Reactive::Data::New1(::STRINGS[4/*"thumbnail"*/]);
    ...
    ::g::Fuse::Reactive::Data* temp6 = ::g::Fuse::Reactive::Data::New1(::STRINGS[5/*"emrals"*/]);
    ::g::Header* temp3 = ::g::Header::New4();
    __this->temp3_Value_inst = ::g::emrals_FuseControlsTextControl_Value_Property::New1(temp3, AlertsPage__Template::__selector0());
    ::g::Fuse::Reactive::Data* temp7 = ::g::Fuse::Reactive::Data::New1(::STRINGS[6/*"solution_pe...*/]);
    ::g::Fuse::Reactive::Data* temp8 = ::g::Fuse::Reactive::Data::New1(::STRINGS[7/*"goToAlert"*/]);
    ::g::Fuse::Controls::Panel* temp9 = ::g::Fuse::Controls::Panel::New3();
    ::g::Fuse::Controls::Rectangle* temp10 = ::g::Fuse::Controls::Rectangle::New3();
    ::g::Fuse::Reactive::DataBinding* temp11 = ::g::Fuse::Reactive::DataBinding::New1(__this->temp_Value_inst, (uObject*)temp4, __this->__g_nametable1, 3);
    ::g::Fuse::Controls::Rectangle* temp12 = ::g::Fuse::Controls::Rectangle::New3();
    ::g::Fuse::Reactive::DataBinding* temp13 = ::g::Fuse::Reactive::DataBinding::New1(__this->temp1_Url_inst, (uObject*)temp5, __this->__g_nametable1, 3);
    ...
    ::g::Fuse::Reactive::DataBinding* temp16 = ::g::Fuse::Reactive::DataBinding::New1(__this->temp3_Value_inst, (uObject*)temp7, __this->__g_nametable1, 3);
    ::g::Fuse::Reactive::EventBinding* temp_eb161 = ::g::Fuse::Reactive::EventBinding::New1((uObject*)temp8, __this->__g_nametable1);
    __self1->Width(::g::Uno::UX::Size__New1(150.0f, 1));
    __self1->Height(::g::Uno::UX::Size__New1(150.0f, 1));
    __self1->Margin(::g::Uno::Float4__New2(20.0f, 20.0f, 20.0f, 20.0f));
    ::g::Fuse::Gestures::Clicked::AddHandler(__self1, uDelegate::New(::TYPES[1/*Fuse.Gestures.ClickedHandler*/], (void*)::g::Fuse::Reactive::EventBinding__OnEvent_fn, temp_eb161));
    ...
    temp10->Width(::g::Uno::UX::Size__New1(97.0f, 4));
    temp10->Opacity(0.8f);
    ::g::Uno::Collections::ICollection::Add_ex(uInterface(uPtr(temp10->Children()), ::TYPES[2/*Uno.Collections.ICollection<Fuse.Node>*/]), temp);
    temp->FontSize(12.0f);
    ...
    temp12->CornerRadius(::g::Uno::Float4__New2(10.0f, 10.0f, 10.0f, 10.0f));
    temp12->Color(::g::Uno::Float4__New2(0.5411765f, 0.7215686f, 0.2784314f, 1.0f));
    temp12->Layer(1);
    ::g::Uno::Collections::ICollection::Add_ex(uInterface(uPtr(temp12->Fills()), ::TYPES[4/*Uno.Collections.ICollection<Fuse.Drawing.Brush>*/]), temp1);
    ::g::Uno::Collections::ICollection::Add_ex(uInterface(uPtr(temp12->Bindings()), ::TYPES[3/*Uno.Collections.ICollection<Fuse.Binding>*/]), temp13);
    temp1->WrapMode(1);
    temp1->StretchMode(6);
    temp14->Height(::g::Uno::UX::Size__New1(22.0f, 1));
    temp14->Alignment(12);
    temp14->Margin(::g::Uno::Float4__New2(-30.0f, 0.0f, 0.0f, -24.0f));
    temp14->File(::g::Uno::UX::BundleFileSource::New1(::g::emrals_bundle::greene8340a685()));
    ...
    temp3->FontSize(18.0f);
    temp3->TextColor(::g::Uno::Float4__New2(1.0f, 0.0f, 0.0f, 1.0f));
    temp3->Alignment(15);
    temp3->Margin(::g::Uno::Float4__New2(74.0f, 0.0f, 0.0f, -24.0f));
    ::g::Uno::Collections::ICollection::Add_ex(uInterface(uPtr(temp3->Bindings()), ::TYPES[3/*Uno.Collections.ICollection<Fuse.Binding>*/]), temp16);
    ::g::Uno::Collections::ICollection::Add_ex(uInterface(uPtr(uPtr(__this->__g_nametable1)->Objects()), ::TYPES[5/*Uno.Collections.ICollection<object>*/]), temp_eb161);
    ...
    ::g::Uno::Collections::ICollection::Add_ex(uInterface(uPtr(__self1->Bindings()), ::TYPES[3/*Uno.Collections.ICollection<Fuse.Binding>*/]), temp_eb161);
