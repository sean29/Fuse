...
struct BuyEcanPage : ::g::Fuse::Controls::Page
{
    ...
    static ::g::Uno::UX::Selector& __selector4() { return BuyEcanPage_typeof()->Init(), __selector4_; }
    static ::g::Uno::UX::Selector __selector5_;
    static ::g::Uno::UX::Selector& __selector5() { return BuyEcanPage_typeof()->Init(), __selector5_; }
