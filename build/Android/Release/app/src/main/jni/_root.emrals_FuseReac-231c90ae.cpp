...
static void emrals_FuseReactiveEach_Items_Property_build(uType* type)
{
    ...
    type->SetFields(1,
        ::TYPES[0/*Fuse.Reactive.Each*/], offsetof(emrals_FuseReactiveEach_Items_Property, _obj), uFieldFlagsWeak);
}
...
// public emrals_FuseReactiveEach_Items_Property(Fuse.Reactive.Each obj, Uno.UX.Selector name) :112
...
// public emrals_FuseReactiveEach_Items_Property New(Fuse.Reactive.Each obj, Uno.UX.Selector name) :112
...
// public emrals_FuseReactiveEach_Items_Property(Fuse.Reactive.Each obj, Uno.UX.Selector name) [instance] :112
...
// public emrals_FuseReactiveEach_Items_Property New(Fuse.Reactive.Each obj, Uno.UX.Selector name) [static] :112
