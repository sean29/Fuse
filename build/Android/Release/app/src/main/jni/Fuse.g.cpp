...
// C:\Users\q\AppData\Local\Fusetools\Packages\Fuse.Android\1.2.0\$.uno
// --------------------------------------------------------------------
...
{
    {
        ...
        WITH_STATIC_JAVA_METHOD(__mtd, __cls, "GetReleaseVersion411", "()Ljava/lang/String;");
...
// C:\Users\q\AppData\Local\Fusetools\Packages\Fuse.Nodes\1.2.0\$.uno
// ------------------------------------------------------------------
...
static void Binding_build(uType* type)
{
    ...
    ::STRINGS[3] = uString::Const("C:\\Users\\q\\AppData\\Local\\Fusetools\\Packages\\Fuse.Nodes\\1.2.0\\$.uno");
...
// C:\Users\q\AppData\Local\Fusetools\Packages\Fuse.Common\1.2.0\$.uno
// -------------------------------------------------------------------
...
// C:\Users\q\AppData\Local\Fusetools\Packages\Fuse.Marshal\1.2.0\$.uno
// --------------------------------------------------------------------
...
void Diagnostic__ToString_fn(Diagnostic* __this, uString** __retval)
{
    ...
    if (::g::Uno::String::op_Inequality(__this->FilePath, NULL))
        msg = ::g::Uno::String::op_Addition2(msg, ::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition1(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::STRINGS[25/*"<"*/], __this->FilePath), ::STRINGS[26/*":"*/]), uBox<int>(::TYPES[47/*int*/], __this->LineNumber)), ::STRINGS[27/*">"*/]));
...
{
    ::STRINGS[33] = uString::Const("Unpopped Scissor");
    ::STRINGS[3] = uString::Const("C:\\Users\\q\\AppData\\Local\\Fusetools\\Packages\\Fuse.Nodes\\1.2.0\\$.uno");
    ::STRINGS[34] = uString::Const("ReleaseRootbuffer");
    ::STRINGS[35] = uString::Const("Unpopped CullFace");
    ::STRINGS[36] = uString::Const("Unpopped Viewport");
    ::STRINGS[37] = uString::Const("Unpopped RenderTarget");
...
void DrawContext::ReleaseRootbuffer()
{
    if (uPtr(_glScissors)->Count() > 0)
        ::g::Fuse::Diagnostics::InternalError(::STRINGS[33/*"Unpopped Sc...*/], this, ::STRINGS[3/*"C:\\Users\\...*/], 609, ::STRINGS[34/*"ReleaseRoot...*/]);

    uPtr(_glScissors)->Clear();

    if (uPtr(_cullFaces)->Count() > 0)
        ::g::Fuse::Diagnostics::InternalError(::STRINGS[35/*"Unpopped Cu...*/], this, ::STRINGS[3/*"C:\\Users\\...*/], 613, ::STRINGS[34/*"ReleaseRoot...*/]);

    uPtr(_cullFaces)->Clear();

    if (uPtr(_viewports)->Count() > 0)
        ::g::Fuse::Diagnostics::InternalError(::STRINGS[36/*"Unpopped Vi...*/], this, ::STRINGS[3/*"C:\\Users\\...*/], 617, ::STRINGS[34/*"ReleaseRoot...*/]);

    uPtr(_viewports)->Clear();

    if (uPtr(_renderTargets)->Count() > 0)
        ::g::Fuse::Diagnostics::InternalError(::STRINGS[37/*"Unpopped Re...*/], this, ::STRINGS[3/*"C:\\Users\\...*/], 621, ::STRINGS[34/*"ReleaseRoot...*/]);
...
uObject* FileSourceConverter::TryConvert(uType* t, uObject* obj)
{
    ...
    if (uIs(obj, ::TYPES[31/*string*/]))
    {
        ...
        return ::g::Fuse::JSFileSource::New1(uAs<uString*>(::g::Fuse::IObject::Item(uInterface(uPtr((uObject*)obj), ::TYPES[13/*Fuse.IObject*/]), ::STRINGS[38/*"path"*/]), ::TYPES[31/*string*/]));
...
{
    Font::Thin_ = ::g::Fuse::SystemFont::New3(::STRINGS[39/*"sans-serif-...*/], 0, 1);
    Font::Light_ = ::g::Fuse::SystemFont::New3(::STRINGS[40/*"sans-serif-...*/], 0, 2);
    Font::Regular_ = ::g::Fuse::SystemFont::New3(::STRINGS[41/*"sans-serif"*/], 0, 3);
    Font::Medium_ = ::g::Fuse::SystemFont::New3(::STRINGS[41/*"sans-serif"*/], 0, 4);
    Font::Bold_ = ::g::Fuse::SystemFont::New3(::STRINGS[41/*"sans-serif"*/], 0, 6);
    Font::ThinItalic_ = ::g::Fuse::SystemFont::New3(::STRINGS[39/*"sans-serif-...*/], 1, 1);
    Font::LightItalic_ = ::g::Fuse::SystemFont::New3(::STRINGS[40/*"sans-serif-...*/], 1, 2);
    Font::Italic_ = ::g::Fuse::SystemFont::New3(::STRINGS[41/*"sans-serif"*/], 1, 3);
    Font::MediumItalic_ = ::g::Fuse::SystemFont::New3(::STRINGS[41/*"sans-serif"*/], 1, 4);
    Font::BoldItalic_ = ::g::Fuse::SystemFont::New3(::STRINGS[41/*"sans-serif"*/], 1, 6);
}

static void Font_build(uType* type)
{
    ::STRINGS[39] = uString::Const("sans-serif-thin");
    ::STRINGS[40] = uString::Const("sans-serif-light");
    ::STRINGS[41] = uString::Const("sans-serif");
    type->SetFields(0,
...
{
    ::STRINGS[42] = uString::Const("Attempted to allocate ");
    ::STRINGS[43] = uString::Const("x");
    ::STRINGS[44] = uString::Const(" framebuffer, max is ");
    ::STRINGS[45] = uString::Const("framebuffer pinned while app going into the background");
    ::STRINGS[46] = uString::Const("Pool is leaking");
...
void FramebufferPoolImpl__FuseResourcesISoftDisposableSoftDispose_fn(FramebufferPoolImpl* __this)
{
    ...
    for (int i = 0; i < uPtr(__this->cacheFramebuffers)->Count(); i++)
    {
        ...
        if (uPtr(c)->IsPinned())
            U_THROW(::g::Uno::Exception::New2(::STRINGS[45/*"framebuffer...*/]));
...
::g::Uno::Graphics::Framebuffer* FramebufferPoolImpl::FindBuffer(int width, int height, int format, int flags)
{
    ...
    if ((width > maxSize) || (height > maxSize))
        U_THROW(::g::Uno::Exception::New2(::g::Uno::String::op_Addition1(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition1(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition1(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition1(::STRINGS[42/*"Attempted t...*/], uBox<int>(::TYPES[47/*int*/], width)), ::STRINGS[43/*"x"*/]), uBox<int>(::TYPES[47/*int*/], height)), ::STRINGS[44/*" framebuffe...*/]), uBox<int>(::TYPES[47/*int*/], maxSize)), ::STRINGS[43/*"x"*/]), uBox<int>(::TYPES[47/*int*/], maxSize))));
...
void FramebufferPoolImpl::Update()
{
    ...
    for (int i = 0; i < uPtr(framebufferPool)->Count(); i++)
    {
        ...
        if (framesSinceUse < 0)
            U_THROW(::g::Uno::Exception::New2(::STRINGS[46/*"Pool is lea...*/]));
...
{
    ::STRINGS[47] = uString::Const("_exceptionQueue mismatch");
    ::STRINGS[48] = uString::Const("GraphicsWorker failed");
    ::STRINGS[49] = uString::Const("C:\\Users\\q\\AppData\\Local\\Fusetools\\Packages\\Fuse.Common\\1.2.0\\$.uno");
...
void GraphicsWorker::DispatchException()
{
    ...
    if (!(::g::Uno::Threading::ConcurrentQueue__TryDequeue_fn(uPtr(GraphicsWorker::_exceptionQueue()), (void**)(&e), &ret1), ret1))
        U_THROW(::g::Uno::Exception::New2(::STRINGS[47/*"_exceptionQ...*/]));
...
void GraphicsWorker::Run()
{
    ...
    while (!GraphicsWorker::_terminating())
    {
        ...
        if ((::g::Uno::Threading::ConcurrentQueue__TryDequeue_fn(uPtr(GraphicsWorker::_work()), (void**)(&a), &ret2), ret2))
        {
            ...
            {
                ::g::Uno::Exception* e = __t.Exception;
                ::g::Fuse::Diagnostics::UnknownException(::STRINGS[48/*"GraphicsWor...*/], e, a, ::STRINGS[49/*"C:\\Users\\...*/], 2197, ::STRINGS[50/*"Run"*/]);
...
// C:\Users\q\AppData\Local\Fusetools\Packages\Fuse.Common\1.2.0\resources\$.uno
// -----------------------------------------------------------------------------
...
static void Marshal_build(uType* type)
{
    ...
    ::STRINGS[11] = uString::Const("'");
    ::STRINGS[69] = uString::Const("C:\\Users\\q\\AppData\\Local\\Fusetools\\Packages\\Fuse.Marshal\\1.2.0\\$.uno");
...
// public static object Add(object a, object b) :526
...
// public static object LessThan(object a, object b) :584
void Marshal__LessThan_fn(uObject* a, uObject* b, uObject** __retval)
{
    *__retval = Marshal::LessThan(a, b);
}

// public static object Multiply(object a, object b) :558
...
// public static object Subtract(object a, object b) :545
...
// private static object TryConvertArrayToVector(object arg) :914
...
// public static object Add(object a, object b) [static] :526
uObject* Marshal::Add(uObject* a, uObject* b)
{
    ...
    if (::g::Uno::Type::op_Equality(ta, ::TYPES[31/*string*/]) || ::g::Uno::Type::op_Equality(tb, ::TYPES[31/*string*/]))
...
// public static object Divide(object a, object b) [static] :571
...
// private static Uno.Type DominantType(Uno.Type a, Uno.Type b) [static] :513
uType* Marshal::DominantType(uType* a, uType* b)
{
    Marshal_typeof()->Init();

    if (::g::Uno::Type::op_Equality(a, ::TYPES[60/*float4*/]))
        return a;

    if (::g::Uno::Type::op_Equality(b, ::TYPES[60/*float4*/]))
        return b;

    if (::g::Uno::Type::op_Equality(a, ::TYPES[59/*float3*/]))
        return a;

    if (::g::Uno::Type::op_Equality(b, ::TYPES[59/*float3*/]))
        return b;

    if (::g::Uno::Type::op_Equality(a, ::TYPES[62/*Uno.UX.Size2*/]))
        return a;

    if (::g::Uno::Type::op_Equality(b, ::TYPES[62/*Uno.UX.Size2*/]))
        return b;
...
// public static object EqualTo(object a, object b) [static] :633
uObject* Marshal::EqualTo(uObject* a, uObject* b)
{
    ...
    if ((::g::Uno::Collections::Dictionary__TryGetValue_fn(uPtr(Marshal::_computers()), t, (void**)(&c), &ret6), ret6))
        return uBox(::TYPES[48/*bool*/], uPtr(c)->EqualTo(a, b));

    U_THROW(::g::Fuse::ComputeException::New4(::STRINGS[14/*"EqualTo"*/], a, b));
}

// public static object GreaterThan(object a, object b) [static] :609
uObject* Marshal::GreaterThan(uObject* a, uObject* b)
{
    ...
    if ((::g::Uno::Collections::Dictionary__TryGetValue_fn(uPtr(Marshal::_computers()), t, (void**)(&c), &ret8), ret8))
        return uBox(::TYPES[48/*bool*/], uPtr(c)->GreaterThan(a, b));
...
// public static object LessThan(object a, object b) [static] :584
uObject* Marshal::LessThan(uObject* a, uObject* b)
{
    ...
    if ((::g::Uno::Collections::Dictionary__TryGetValue_fn(uPtr(Marshal::_computers()), t, (void**)(&c), &ret10), ret10))
        return uBox(::TYPES[48/*bool*/], uPtr(c)->LessThan(a, b));

    U_THROW(::g::Fuse::ComputeException::New4(::STRINGS[16/*"LessThan"*/], a, b));
}

// public static object Multiply(object a, object b) [static] :558
...
// public static object Subtract(object a, object b) [static] :545
...
// private static object TryConvertArrayToVector(object arg) [static] :914
uObject* Marshal::TryConvertArrayToVector(uObject* arg)
{
    Marshal_typeof()->Init();
    uObject* arr = uAs<uObject*>(arg, ::TYPES[53/*Fuse.IArray*/]);
...
bool Marshal::TryConvertTo(uType* t, uObject* o, uObject** res, uObject* diagnosticSource)
{
    ...
    if (diagnosticSource != NULL)
        ::g::Fuse::Diagnostics::UserError(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition1(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition1(::STRINGS[67/*"Cannot conv...*/], o), ::STRINGS[68/*"' to target...*/]), t), ::STRINGS[11/*"'"*/]), diagnosticSource, ::STRINGS[69/*"C:\\Users\\...*/], 746, ::STRINGS[70/*"TryConvertTo"*/], NULL);
...
static void Node__cctor__fn(uType* __type)
{
    ...
    ::g::Fuse::Scripting::ScriptClass::Register(__type, uArray::Init< ::g::Fuse::Scripting::ScriptMember*>(::TYPES[78/*Fuse.Scripting.ScriptMember[]*/], 3, (::g::Fuse::Scripting::ScriptMethod1*)::g::Fuse::Scripting::ScriptMethod1::New2(::TYPES[79/*Fuse.Scripting.ScriptMethod<Fuse.Node>*/], ::STRINGS[72/*"_createWatc...*/], uDelegate::New(::TYPES[80/*Uno.Func<Fuse.Scripting.Context, Fuse.Node, object[], object>*/], (void*)Node___createWatcher_fn), 1), (::g::Fuse::Scripting::ScriptMethod1*)::g::Fuse::Scripting::ScriptMethod1::New1(::TYPES[79/*Fuse.Scripting.ScriptMethod<Fuse.Node>*/], ::STRINGS[73/*"_destroyWat...*/], uDelegate::New(::TYPES[81/*Uno.Action<Fuse.Scripting.Context, Fuse.Node, object[]>*/], (void*)Node___destroyWatcher_fn), 1), (::g::Fuse::Scripting::ScriptMethodInline*)::g::Fuse::Scripting::ScriptMethodInline::New1(::STRINGS[74/*"findData"*/], 1, ::STRINGS[75/*"function(ke...*/])));
}
...
void Node__ToString_fn(Node* __this, uString** __retval)
{
    ...
    if (!__this->Name().IsNull())
        return *__retval = ::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2((::g::Uno::Object__ToString_fn(__this, &ret12), ret12), ::STRINGS[80/*", Name: "*/]), __this->Name().ToString(::TYPES[93/*Uno.UX.Selector*/])), void();
    else
...
static void NodeGroupBase_build(uType* type)
{
    ...
    ::STRINGS[85] = uString::Const("Template contains a non-Node");
    ::STRINGS[86] = uString::Const("mismatch in added nodes");
...
void NodeGroupBase::AddContent()
{
    ...
    if (Parent() == NULL)
    {
        ::g::Fuse::Diagnostics::InternalError(::STRINGS[82/*"AddContent ...*/], this, ::STRINGS[3/*"C:\\Users\\...*/], 3285, ::STRINGS[83/*"AddContent"*/]);
        return;
    }
    ...
    if (where == -1)
    {
        ::g::Fuse::Diagnostics::InternalError(::STRINGS[84/*"Could not l...*/], this, ::STRINGS[3/*"C:\\Users\\...*/], 3304, ::STRINGS[83/*"AddContent"*/]);
        return;
    }
    ...
    if (_useTemplates)
        ...
        for (int i2 = 0; i2 < _templates.Count(); ++i2)
        {
            ...
            if (n1 == NULL)
            {
                ::g::Fuse::Diagnostics::InternalError(::STRINGS[85/*"Template co...*/], this, ::STRINGS[3/*"C:\\Users\\...*/], 3326, ::STRINGS[83/*"AddContent"*/]);
    ...
    if (addedNodesAt != addedNodesCount)
        U_THROW(::g::Uno::Exception::New2(::STRINGS[86/*"mismatch in...*/]));
...
{
    Visual__ParameterProperty::_name1_ = ::g::Uno::UX::Selector__op_Implicit(::STRINGS[87/*"Parameter"*/]);
}

static void Visual__ParameterProperty_build(uType* type)
{
    ::STRINGS[87] = uString::Const("Parameter");
...
uString* PhoneUriHelper::PhoneNumberToUri(uString* phoneNumber)
{
    ...
    builder->Append2(::STRINGS[88/*"tel:"*/]);
...
{
    ::STRINGS[43] = uString::Const("x");
    ::STRINGS[89] = uString::Const("y");
    ::STRINGS[90] = uString::Const("width");
    ::STRINGS[91] = uString::Const("height");
...
{
    ::g::Fuse::Scripting::IEventSerializer::AddDouble(uInterface(uPtr(serializer), ::TYPES[106/*Fuse.Scripting.IEventSerializer*/]), ::STRINGS[43/*"x"*/], (double)NewPosition().X);
    ::g::Fuse::Scripting::IEventSerializer::AddDouble(uInterface(serializer, ::TYPES[106/*Fuse.Scripting.IEventSerializer*/]), ::STRINGS[89/*"y"*/], (double)NewPosition().Y);
    ::g::Fuse::Scripting::IEventSerializer::AddDouble(uInterface(serializer, ::TYPES[106/*Fuse.Scripting.IEventSerializer*/]), ::STRINGS[90/*"width"*/], (double)NewSize().X);
    ::g::Fuse::Scripting::IEventSerializer::AddDouble(uInterface(serializer, ::TYPES[106/*Fuse.Scripting.IEventSerializer*/]), ::STRINGS[91/*"height"*/], (double)NewSize().Y);
}
...
{
    ::STRINGS[92] = uString::Const("no Action found to remove");
...
void UpdateManager::RemoveAction(uObject* pu, int stage)
{
    ...
    if (!UpdateManager::RemoveFrom(uPtr(s)->Listeners, NULL, pu))
        U_THROW(::g::Uno::Exception::New2(::STRINGS[92/*"no Action f...*/]));
...
// C:\Users\q\AppData\Local\Fusetools\Packages\Fuse.UserEvents\1.2.0\$.uno
// -----------------------------------------------------------------------
...
{
    ::g::Fuse::Scripting::ScriptClass::Register(__type, uArray::Init< ::g::Fuse::Scripting::ScriptMember*>(::TYPES[78/*Fuse.Scripting.ScriptMember[]*/], 1, (::g::Fuse::Scripting::ScriptMethod1*)::g::Fuse::Scripting::ScriptMethod1::New1(::TYPES[120/*Fuse.Scripting.ScriptMethod<Fuse.UserEvent>*/], ::STRINGS[93/*"raise"*/], uDelegate::New(::TYPES[121/*Uno.Action<Fuse.Scripting.Context, Fuse.UserEvent, object[]>*/], (void*)UserEvent__raise_fn), 2)));
}

static void UserEvent_build(uType* type)
{
    ::STRINGS[93] = uString::Const("raise");
    ::STRINGS[94] = uString::Const("UserEvent requires a Name");
    ::STRINGS[95] = uString::Const("C:\\Users\\q\\AppData\\Local\\Fusetools\\Packages\\Fuse.UserEvents\\1.2.0\\$.uno");
    ::STRINGS[96] = uString::Const("OnRooted");
    ::STRINGS[97] = uString::Const("Raise must be called with zero arguments, or one argument defining the arguments to the event");
    ::STRINGS[98] = uString::Const("Raise must be called with a JavaScript object to define name/value pairs");
    ::STRINGS[99] = uString::Const("Trying to Raise on unrooted UserEvent");
    ::STRINGS[100] = uString::Const("Raise");
    ::TYPES[30] = ::g::Uno::Type_typeof();
    ::TYPES[78] = ::g::Fuse::Scripting::ScriptMember_typeof()->Array();
...
void UserEvent__OnRooted_fn(UserEvent* __this)
{
    ...
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[94/*"UserEvent r...*/], __this, ::STRINGS[95/*"C:\\Users\\...*/], 654, ::STRINGS[96/*"OnRooted"*/], NULL);
        return;
    }
...
void UserEvent::Raise(::g::Uno::Collections::Dictionary* args)
{
    if (Dispatch == NULL)
    {
        ::g::Fuse::Diagnostics::InternalError(::STRINGS[99/*"Trying to R...*/], this, ::STRINGS[95/*"C:\\Users\\...*/], 701, ::STRINGS[100/*"Raise"*/]);
        return;
    }
...
void UserEvent::raise(::g::Fuse::Scripting::Context* c, UserEvent* n, uArray* args)
{
    ...
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[97/*"Raise must ...*/], n, ::STRINGS[95/*"C:\\Users\\...*/], 421, ::STRINGS[93/*"raise"*/], NULL);
        return;
    }
    ...
    if (so == NULL)
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[98/*"Raise must ...*/], uPtr(args)->Strong<uObject*>(0), ::STRINGS[95/*"C:\\Users\\...*/], 428, ::STRINGS[93/*"raise"*/], NULL);
        return;
    }
...
void UserEventArgs__FuseScriptingIScriptEventSerialize_fn(UserEventArgs* __this, uObject* s)
{
    ...
    ::g::Fuse::Scripting::IEventSerializer::AddString(uInterface(uPtr(s), ::TYPES[106/*Fuse.Scripting.IEventSerializer*/]), ::STRINGS[101/*"name"*/], ::g::Uno::UX::Selector__op_Implicit1(uPtr(__this->Dispatch())->Name()));
...
static void Visual__cctor_1_fn(uType* __type)
{
    ...
    Visual::_isEnabledName_ = ::g::Uno::UX::Selector__op_Implicit(::STRINGS[102/*"IsEnabled"*/]);
    ...
    Visual::ParameterName_ = ::g::Uno::UX::Selector__op_Implicit(::STRINGS[87/*"Parameter"*/]);
    Visual::_resourcesHandle_ = ::g::Fuse::Properties::CreateHandle();
    ::g::Fuse::Scripting::ScriptClass::Register(__type, uArray::Init< ::g::Fuse::Scripting::ScriptMember*>(::TYPES[78/*Fuse.Scripting.ScriptMember[]*/], 3, (::g::Fuse::Scripting::ScriptProperty1*)::g::Fuse::Scripting::ScriptProperty1::New1(::TYPES[128/*Fuse.Scripting.ScriptProperty<Fuse.Visual, string>*/], ::STRINGS[87/*"Parameter"*/], uDelegate::New(::TYPES[129/*Uno.Func<Fuse.Visual, Uno.UX.Property<string>>*/], (void*)Visual__getParameterProperty_fn), ::STRINGS[103/*".notNull()....*/]), (::g::Fuse::Scripting::ScriptMethod1*)::g::Fuse::Scripting::ScriptMethod1::New1(::TYPES[130/*Fuse.Scripting.ScriptMethod<Fuse.Visual>*/], ::STRINGS[104/*"onParameter...*/], uDelegate::New(::TYPES[131/*Uno.Action<Fuse.Scripting.Context, Fuse.Visual, object[]>*/], (void*)Visual__onParameterChanged_fn), 2), (::g::Fuse::Scripting::ScriptMethod1*)::g::Fuse::Scripting::ScriptMethod1::New1(::TYPES[130/*Fuse.Scripting.ScriptMethod<Fuse.Visual>*/], ::STRINGS[105/*"bringIntoView"*/], uDelegate::New(::TYPES[131/*Uno.Action<Fuse.Scripting.Context, Fuse.Visual, object[]>*/], (void*)Visual__bringIntoView_fn), 2)));
}

static void Visual_build(uType* type)
{
    ::STRINGS[102] = uString::Const("IsEnabled");
    ::STRINGS[87] = uString::Const("Parameter");
    ::STRINGS[103] = uString::Const(".notNull().parseJson()");
    ::STRINGS[104] = uString::Const("onParameterChanged");
    ::STRINGS[105] = uString::Const("bringIntoView");
    ::STRINGS[106] = uString::Const("index");
    ::STRINGS[107] = uString::Const("Layout was invalidated while performing layout");
    ::STRINGS[108] = uString::Const("Invalid call to RearrangeMarginBox");
    ::TYPES[30] = ::g::Uno::Type_typeof();
    ::TYPES[78] = ::g::Fuse::Scripting::ScriptMember_typeof()->Array();
...
void Visual::InsertNodesImpl(int index, uObject* items, bool allowMove)
{
    ...
    if ((index < 0) || (index > ::g::Uno::Collections::ICollection::Count(uInterface(uPtr(Children()), ::TYPES[1/*Uno.Collections.ICollection<Fuse.Node>*/]))))
        U_THROW(::g::Uno::ArgumentOutOfRangeException::New6(::STRINGS[106/*"index"*/]));
...
void Visual::InvalidateLayout(int reason)
{
    if (Visual::_performingLayout())
        U_THROW(::g::Uno::Exception::New2(::STRINGS[107/*"Layout was ...*/]));
...
{
    if (!HasMarginBox())
        U_THROW(::g::Uno::Exception::New2(::STRINGS[108/*"Invalid cal...*/]));
...
{
    ::STRINGS[109] = uString::Const("visual");
    type->SetInterfaces(
...
void VisualEventArgs::ctor_1(::g::Fuse::Visual* visual)
{
    ...
    if (visual == NULL)
        U_THROW(::g::Uno::ArgumentNullException::New6(::STRINGS[109/*"visual"*/]));
...
{
    ::STRINGS[110] = uString::Const("Wrapped Exception");
    type->SetFields(4);
}
...
{
    ctor_2(::STRINGS[110/*"Wrapped Exc...*/], inner);
}
