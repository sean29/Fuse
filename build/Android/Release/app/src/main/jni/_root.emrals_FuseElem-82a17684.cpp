...
static void emrals_FuseElementsElement_Opacity_Property_build(uType* type)
{
    ...
    type->SetFields(1,
        ::TYPES[0/*Fuse.Elements.Element*/], offsetof(emrals_FuseElementsElement_Opacity_Property, _obj), uFieldFlagsWeak);
}
...
// public emrals_FuseElementsElement_Opacity_Property(Fuse.Elements.Element obj, Uno.UX.Selector name) :79
...
// public override sealed float Get(Uno.UX.PropertyObject obj) :81
...
// public emrals_FuseElementsElement_Opacity_Property New(Fuse.Elements.Element obj, Uno.UX.Selector name) :79
...
// public override sealed void Set(Uno.UX.PropertyObject obj, float v, Uno.UX.IPropertyListener origin) :82
...
// public emrals_FuseElementsElement_Opacity_Property(Fuse.Elements.Element obj, Uno.UX.Selector name) [instance] :79
...
// public emrals_FuseElementsElement_Opacity_Property New(Fuse.Elements.Element obj, Uno.UX.Selector name) [static] :79
