...
// public ResultClosure(Uno.Threading.Promise<string> promise, Uno.Net.Http.HttpMessageHandlerRequest request) :85
...
// public ResultClosure New(Uno.Threading.Promise<string> promise, Uno.Net.Http.HttpMessageHandlerRequest request) :85
...
// private void Timeout(Uno.Net.Http.HttpMessageHandlerRequest r) :103
void Uploader__ResultClosure__Timeout_fn(Uploader__ResultClosure* __this, ::g::Uno::Net::Http::HttpMessageHandlerRequest* r)
{
    __this->Timeout(r);
}

// public ResultClosure(Uno.Threading.Promise<string> promise, Uno.Net.Http.HttpMessageHandlerRequest request) [instance] :85
...
// private void Aborted(Uno.Net.Http.HttpMessageHandlerRequest r) [instance] :101
...
// private void Done(Uno.Net.Http.HttpMessageHandlerRequest r) [instance] :95
...
// private void Error(Uno.Net.Http.HttpMessageHandlerRequest r, string message) [instance] :99
...
// private void Timeout(Uno.Net.Http.HttpMessageHandlerRequest r) [instance] :103
...
// public ResultClosure New(Uno.Threading.Promise<string> promise, Uno.Net.Http.HttpMessageHandlerRequest request) [static] :85
