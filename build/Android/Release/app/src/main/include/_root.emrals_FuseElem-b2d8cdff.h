...
namespace g{struct emrals_FuseElementsElement_Width_Property;}
...
struct emrals_FuseElementsElement_Width_Property : ::g::Uno::UX::Property1
{
    uWeak< ::g::Fuse::Elements::Element*> _obj;

    void ctor_3(::g::Fuse::Elements::Element* obj, ::g::Uno::UX::Selector name);
    static emrals_FuseElementsElement_Width_Property* New1(::g::Fuse::Elements::Element* obj, ::g::Uno::UX::Selector name);
};
// }
