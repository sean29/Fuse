// This file was generated based on '.uno/ux11/MyLoadingIndicator2.g.uno'.
...
// {
// static MyLoadingIndicator2() :30
static void MyLoadingIndicator2__cctor_4_fn(uType* __type)
{
    MyLoadingIndicator2::__g_static_nametable1_ = uArray::Init<uString*>(::TYPES[0/*string[]*/], 2, ::STRINGS[0/*"rotatingStr...*/], ::STRINGS[1/*"myTimeline"*/]);
    MyLoadingIndicator2::__selector0_ = ::g::Uno::UX::Selector__op_Implicit(::STRINGS[2/*"Color"*/]);
    MyLoadingIndicator2::__selector1_ = ::g::Uno::UX::Selector__op_Implicit(::STRINGS[3/*"ThemeColor"*/]);
    MyLoadingIndicator2::__selector2_ = ::g::Uno::UX::Selector__op_Implicit(::STRINGS[4/*"TargetProgr...*/]);
    MyLoadingIndicator2::__selector3_ = ::g::Uno::UX::Selector__op_Implicit(::STRINGS[0/*"rotatingStr...*/]);
    MyLoadingIndicator2::__selector4_ = ::g::Uno::UX::Selector__op_Implicit(::STRINGS[1/*"myTimeline"*/]);
}

static void MyLoadingIndicator2_build(uType* type)
{
    ...
    type->SetFields(105,
        ::g::Uno::UX::NameTable_typeof(), offsetof(::g::MyLoadingIndicator2, __g_nametable1), 0,
        ::g::Uno::Float4_typeof(), offsetof(::g::MyLoadingIndicator2, _field_ThemeColor), 0,
        ::g::Fuse::Triggers::Timeline_typeof(), offsetof(::g::MyLoadingIndicator2, myTimeline), 0,
        ::g::Uno::UX::Property1_typeof()->MakeType(::g::Uno::Double_typeof(), NULL), offsetof(::g::MyLoadingIndicator2, myTimeline_TargetProgress_inst), 0,
        ::g::Fuse::Controls::Circle_typeof(), offsetof(::g::MyLoadingIndicator2, rotatingStroke), 0,
        ::g::Uno::UX::Property1_typeof()->MakeType(::g::Uno::Float4_typeof(), NULL), offsetof(::g::MyLoadingIndicator2, temp_Color_inst), 0,
        ::g::Uno::UX::Property1_typeof()->MakeType(::g::Uno::Float4_typeof(), NULL), offsetof(::g::MyLoadingIndicator2, temp1_Color_inst), 0,
        ::g::Uno::UX::Property1_typeof()->MakeType(::g::Uno::Float4_typeof(), NULL), offsetof(::g::MyLoadingIndicator2, this_ThemeColor_inst), 0,
        ::TYPES[0/*string[]*/], (uintptr_t)&::g::MyLoadingIndicator2::__g_static_nametable1_, uFieldFlagsStatic,
        ::g::Uno::UX::Selector_typeof(), (uintptr_t)&::g::MyLoadingIndicator2::__selector0_, uFieldFlagsStatic,
        ::g::Uno::UX::Selector_typeof(), (uintptr_t)&::g::MyLoadingIndicator2::__selector1_, uFieldFlagsStatic,
        ::g::Uno::UX::Selector_typeof(), (uintptr_t)&::g::MyLoadingIndicator2::__selector2_, uFieldFlagsStatic,
        ::g::Uno::UX::Selector_typeof(), (uintptr_t)&::g::MyLoadingIndicator2::__selector3_, uFieldFlagsStatic,
        ::g::Uno::UX::Selector_typeof(), (uintptr_t)&::g::MyLoadingIndicator2::__selector4_, uFieldFlagsStatic);
}
...
::g::Fuse::Controls::Panel_type* MyLoadingIndicator2_typeof()
{
    ...
    options.ObjectSize = sizeof(MyLoadingIndicator2);
    options.TypeSize = sizeof(::g::Fuse::Controls::Panel_type);
    type = (::g::Fuse::Controls::Panel_type*)uClassType::New("MyLoadingIndicator2", options);
    type->fp_build_ = MyLoadingIndicator2_build;
    type->fp_ctor_ = (void*)MyLoadingIndicator2__New4_fn;
    type->fp_cctor_ = MyLoadingIndicator2__cctor_4_fn;
...
// public MyLoadingIndicator2 New() :34
void MyLoadingIndicator2__New4_fn(MyLoadingIndicator2** __retval)
{
    *__retval = MyLoadingIndicator2::New4();
}
...
uSStrong<uArray*> MyLoadingIndicator2::__g_static_nametable1_;
::g::Uno::UX::Selector MyLoadingIndicator2::__selector0_;
::g::Uno::UX::Selector MyLoadingIndicator2::__selector1_;
::g::Uno::UX::Selector MyLoadingIndicator2::__selector2_;
::g::Uno::UX::Selector MyLoadingIndicator2::__selector3_;
::g::Uno::UX::Selector MyLoadingIndicator2::__selector4_;

// public MyLoadingIndicator2() [instance] :34
void MyLoadingIndicator2::ctor_7()
{
    ctor_6();
    InitializeUX();
}
...
void MyLoadingIndicator2::InitializeUX()
{
    ::g::Fuse::Reactive::This* temp2 = ::g::Fuse::Reactive::This::New1();
    ::g::Fuse::Drawing::Stroke* temp = ::g::Fuse::Drawing::Stroke::New2();
    temp_Color_inst = ::g::emrals_FuseDrawingStroke_Color_Property::New1(temp, MyLoadingIndicator2::__selector0());
    ::g::Fuse::Reactive::Property* temp3 = ::g::Fuse::Reactive::Property::New1(temp2, ::g::emrals_accessor_MyLoadingIndicator2_ThemeColor::Singleton());
    this_ThemeColor_inst = ::g::emrals_MyLoadingIndicator2_ThemeColor_Property::New1(this, MyLoadingIndicator2::__selector1());
    __g_nametable1 = ::g::Uno::UX::NameTable::New1(NULL, MyLoadingIndicator2::__g_static_nametable1());
    ::g::Fuse::Reactive::This* temp4 = ::g::Fuse::Reactive::This::New1();
    ::g::Fuse::Controls::Circle* temp1 = ::g::Fuse::Controls::Circle::New3();
    temp1_Color_inst = ::g::emrals_FuseControlsShape_Color_Property::New1(temp1, MyLoadingIndicator2::__selector0());
    ::g::Fuse::Reactive::Property* temp5 = ::g::Fuse::Reactive::Property::New1(temp4, ::g::emrals_accessor_MyLoadingIndicator2_ThemeColor::Singleton());
    myTimeline = ::g::Fuse::Triggers::Timeline::New2();
    myTimeline_TargetProgress_inst = ::g::emrals_FuseTriggersTimeline_TargetProgress_Property::New1(myTimeline, MyLoadingIndicator2::__selector2());
    ...
    uPtr(rotatingStroke)->Name(MyLoadingIndicator2::__selector3());
    ...
    uPtr(myTimeline)->Name(MyLoadingIndicator2::__selector4());
...
void MyLoadingIndicator2::SetThemeColor(::g::Uno::Float4 value, uObject* origin)
{
...
::g::Uno::Float4 MyLoadingIndicator2::ThemeColor()
{
    return _field_ThemeColor;
}

// public void set_ThemeColor(float4 value) [instance] :9
void MyLoadingIndicator2::ThemeColor(::g::Uno::Float4 value)
{
    SetThemeColor(value, NULL);
}

// public MyLoadingIndicator2 New() [static] :34
MyLoadingIndicator2* MyLoadingIndicator2::New4()
{
    MyLoadingIndicator2* obj1 = (MyLoadingIndicator2*)uNew(MyLoadingIndicator2_typeof());
    obj1->ctor_7();
    return obj1;
}
// }
