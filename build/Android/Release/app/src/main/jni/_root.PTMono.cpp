// This file was generated based on '.uno/ux13/PTMono.g.uno'.
...
// public partial sealed class PTMono :2
// {
// static PTMono() :4
static void PTMono__cctor_4_fn(uType* __type)
{
}

static void PTMono_build(uType* type)
{
    type->SetInterfaces(
...
::g::Fuse::Controls::TextControl_type* PTMono_typeof()
{
    ...
    options.ObjectSize = sizeof(PTMono);
    options.TypeSize = sizeof(::g::Fuse::Controls::TextControl_type);
    type = (::g::Fuse::Controls::TextControl_type*)uClassType::New("PTMono", options);
    type->fp_build_ = PTMono_build;
    type->fp_ctor_ = (void*)PTMono__New4_fn;
    type->fp_cctor_ = PTMono__cctor_4_fn;
...
// public PTMono() :8
void PTMono__ctor_8_fn(PTMono* __this)
{
    __this->ctor_8();
}

// private void InitializeUX() :12
void PTMono__InitializeUX1_fn(PTMono* __this)
{
    __this->InitializeUX1();
}

// public PTMono New() :8
void PTMono__New4_fn(PTMono** __retval)
{
    *__retval = PTMono::New4();
}

// public PTMono() [instance] :8
void PTMono::ctor_8()
{
    ctor_7();
    InitializeUX1();
...
void PTMono::InitializeUX1()
{
    FontSize(18.0f);
    Color(::g::Uno::Float4__New2(0.9411765f, 0.3490196f, 0.3490196f, 1.0f));
    Font(::g::BuyEcanPage::PTMono());
}

// public PTMono New() [static] :8
PTMono* PTMono::New4()
{
    PTMono* obj1 = (PTMono*)uNew(PTMono_typeof());
    obj1->ctor_8();
    return obj1;
}
// }
