...
// C:\Users\q\AppData\Local\Fusetools\Packages\Fuse.Elements\1.2.0\$.uno
// ---------------------------------------------------------------------
...
// C:\Users\q\AppData\Local\Fusetools\Packages\Fuse.Elements\1.2.0\caching\$.uno
// -----------------------------------------------------------------------------
...
static void Element_build(uType* type)
{
    ...
    ::STRINGS[6] = uString::Const("C:\\Users\\q\\AppData\\Local\\Fusetools\\Packages\\Fuse.Elements\\1.2.0\\$.uno");
    ...
    ::STRINGS[11] = uString::Const("Invalid values in ArrangeMarginBox");
    ::STRINGS[12] = uString::Const("OnArrangeMarginBox");
...
void Element__Draw_fn(Element* __this, ::g::Fuse::DrawContext* dc)
{
    if (!__this->IsRootingCompleted())
        ::g::Fuse::Diagnostics::InternalError(::STRINGS[9/*"Draw called...*/], __this, ::STRINGS[6/*"C:\\Users\\...*/], 940, ::STRINGS[10/*"Draw"*/]);
...
void Element__OnArrangeMarginBox_fn(Element* __this, ::g::Uno::Float2* position, ::g::Fuse::LayoutParams* lp, ::g::Uno::Float2* __retval)
{
    ...
    if (bp.SanityConstrain())
    {
        if (!Element::_invalidValuesWarn())
            ::g::Fuse::Diagnostics::InternalError(::STRINGS[11/*"Invalid val...*/], __this, ::STRINGS[6/*"C:\\Users\\...*/], 2113, ::STRINGS[12/*"OnArrangeMa...*/]);
...
void Element::Composit(::g::Fuse::DrawContext* dc)
{
    ...
    if (!flat && !_warnOpacityFlat)
    {
        ...
        ::g::Fuse::Diagnostics::UserWarning(::STRINGS[5/*"This elemen...*/], this, ::STRINGS[6/*"C:\\Users\\...*/], 1119, ::STRINGS[7/*"Composit"*/]);
    }
    ...
    if (!r && !_warnNoCacheDraw)
    {
        ...
        ::g::Fuse::Diagnostics::InternalError(::STRINGS[8/*"This elemen...*/], this, ::STRINGS[6/*"C:\\Users\\...*/], 1127, ::STRINGS[7/*"Composit"*/]);
    }
}
