// This file was generated based on '.uno/ux13/EcansPage.g.uno'.
...
// public partial class EcansPage :2
// {
// static EcansPage() :8
static void EcansPage__cctor_4_fn(uType* __type)
{
    ::g::Uno::UX::Selector_typeof()->Init();
    EcansPage::__selector0_ = ::g::Uno::UX::Selector__op_Implicit(::STRINGS[0/*"Color"*/]);
...
static void EcansPage_build(uType* type)
{
    ...
    ::STRINGS[2] = uString::Const("goToBuyEcan");
    ::STRINGS[3] = uString::Const("ECANS");
    ::STRINGS[4] = uString::Const("Say Hello");
    ::STRINGS[5] = uString::Const("to eCan");
    ::STRINGS[6] = uString::Const("The smart trash bin that rewards you for cleaning up.");
    ::STRINGS[7] = uString::Const("eCans Around the World");
    ::STRINGS[8] = uString::Const("The eCan at PS 333");
    ::STRINGS[9] = uString::Const("This classroom loves recyling! The eCan helps keep track of items by showing data about what they toss. Its barcode scanner and interactive touchscreen are fun, too.");
    ::STRINGS[10] = uString::Const("Downtown Brooklyn Solar eCan");
    ::STRINGS[11] = uString::Const("Our first steel eCan designed for outdoor use on city trash cans is solar powered and awaiting installation in Downtown Brooklyn.");
    ::STRINGS[12] = uString::Const("Buildinglink Commercial Space eCan");
    ::STRINGS[13] = uString::Const("One of our first sales to a forward thinking company, the Buildinglink eCan is currently being updated to the newer model with barcode scanning capabilities.");
    ::STRINGS[14] = uString::Const("eCan at Pop Up Shop");
    ::STRINGS[15] = uString::Const("Our multicultural eCan thanked people at this holiday pop up in Soho in seven different languages. Nothing says thank you like \342\200\234thank you, merci, gracias, etc!\342\200\235");
    ::STRINGS[16] = uString::Const("eCan at Automotive HS");
    ::STRINGS[17] = uString::Const("As part of our Shuttleworth Foundation Grant, the Automotive HS will be receiving the second donated eCan.");
    ::STRINGS[18] = uString::Const("BUY ECAN");
    ...
    type->SetFields(117,
        ::g::Fuse::Controls::Rectangle_typeof(), offsetof(EcansPage, buyecanrec), 0,
        ::g::Uno::UX::Property1_typeof()->MakeType(::g::Uno::Float4_typeof(), NULL), offsetof(EcansPage, buyecanrec_Color_inst), 0,
        ::g::Fuse::Navigation::Router_typeof(), offsetof(EcansPage, router), 0,
        ::g::Fuse::Reactive::EventBinding_typeof(), offsetof(EcansPage, temp_eb33), 0,
        ::g::Uno::UX::Selector_typeof(), (uintptr_t)&EcansPage::__selector0_, uFieldFlagsStatic,
        ::g::Uno::UX::Selector_typeof(), (uintptr_t)&EcansPage::__selector1_, uFieldFlagsStatic);
}
...
// public EcansPage(Fuse.Navigation.Router router) :12
...
// public EcansPage(Fuse.Navigation.Router router) [instance] :12
...
void EcansPage::InitializeUX()
{
    ...
    buyecanrec_Color_inst = ::g::emrals_FuseControlsShape_Color_Property::New1(buyecanrec, EcansPage::__selector0_);
    ::g::Fuse::Reactive::Data* temp = ::g::Fuse::Reactive::Data::New1(::STRINGS[2/*"goToBuyEcan"*/]);
    ...
    ::g::Fuse::Animations::Change* temp47 = (::g::Fuse::Animations::Change*)::g::Fuse::Animations::Change::New2(::TYPES[0/*Fuse.Animations.Change<float4>*/], buyecanrec_Color_inst);
    temp_eb33 = ::g::Fuse::Reactive::EventBinding::New1((uObject*)temp);
    ...
    ::g::Uno::Collections::ICollection::Add_ex(uInterface(uPtr(temp4->Children()), ::TYPES[1/*Uno.Collections.ICollection<Fuse.Node>*/]), temp11);
    ::g::Uno::Collections::ICollection::Add_ex(uInterface(uPtr(temp4->Children()), ::TYPES[1/*Uno.Collections.ICollection<Fuse.Node>*/]), temp12);
    ::g::Uno::Collections::ICollection::Add_ex(uInterface(uPtr(temp4->Children()), ::TYPES[1/*Uno.Collections.ICollection<Fuse.Node>*/]), buyecanrec);
    ...
    temp6->Value(::STRINGS[4/*"Say Hello"*/]);
    ...
    temp9->Value(::STRINGS[6/*"The smart t...*/]);
    ...
    temp10->File(::g::Uno::UX::BundleFileSource::New1(::g::emrals_bundle::ECANnotesd43bc5d7()));
    temp11->Value(::STRINGS[7/*"eCans Aroun...*/]);
    temp11->Alignment(10);
    temp12->LayoutMode(1);
    ...
    ::g::Uno::Collections::ICollection::Add_ex(uInterface(uPtr(temp13->Children()), ::TYPES[1/*Uno.Collections.ICollection<Fuse.Node>*/]), temp26);
    ::g::Uno::Collections::ICollection::Add_ex(uInterface(uPtr(temp13->Children()), ::TYPES[1/*Uno.Collections.ICollection<Fuse.Node>*/]), temp32);
    ::g::Uno::Collections::ICollection::Add_ex(uInterface(uPtr(temp13->Children()), ::TYPES[1/*Uno.Collections.ICollection<Fuse.Node>*/]), temp38);
    ...
    temp15->Alignment(5);
    temp15->File(::g::Uno::UX::BundleFileSource::New1(::g::emrals_bundle::ecan10caee7d5()));
    ...
    temp17->Value(::STRINGS[8/*"The eCan at...*/]);
    ...
    temp19->Value(::STRINGS[9/*"This classr...*/]);
    ...
    temp21->Alignment(5);
    temp21->File(::g::Uno::UX::BundleFileSource::New1(::g::emrals_bundle::ecan2182cc5f0()));
    ...
    temp23->Value(::STRINGS[10/*"Downtown Br...*/]);
    ...
    temp25->Value(::STRINGS[11/*"Our first s...*/]);
    ...
    temp27->Alignment(5);
    temp27->File(::g::Uno::UX::BundleFileSource::New1(::g::emrals_bundle::ecan3c29eab8b()));
    ...
    temp29->Value(::STRINGS[12/*"Buildinglin...*/]);
    ...
    temp31->Value(::STRINGS[13/*"One of our ...*/]);
    ...
    ::g::Uno::Collections::ICollection::Add_ex(uInterface(uPtr(temp32->Children()), ::TYPES[1/*Uno.Collections.ICollection<Fuse.Node>*/]), temp34);
    ::g::Uno::Collections::ICollection::Add_ex(uInterface(uPtr(temp32->Children()), ::TYPES[1/*Uno.Collections.ICollection<Fuse.Node>*/]), temp36);
    temp33->MaxHeight(::g::Uno::UX::Size__New1(92.0f, 1));
    temp33->Alignment(5);
    temp33->File(::g::Uno::UX::BundleFileSource::New1(::g::emrals_bundle::ecan460557fce()));
    ...
    temp35->Value(::STRINGS[14/*"eCan at Pop...*/]);
    ...
    temp37->Value(::STRINGS[15/*"Our multicu...*/]);
    ...
    ::g::Uno::Collections::ICollection::Add_ex(uInterface(uPtr(temp38->Children()), ::TYPES[1/*Uno.Collections.ICollection<Fuse.Node>*/]), temp42);
    temp39->MaxHeight(::g::Uno::UX::Size__New1(92.0f, 1));
    temp39->Alignment(5);
    temp39->File(::g::Uno::UX::BundleFileSource::New1(::g::emrals_bundle::ecan5a0cf6069()));
    ...
    temp41->Value(::STRINGS[16/*"eCan at Aut...*/]);
    ...
    temp43->Value(::STRINGS[17/*"As part of ...*/]);
    ...
    uPtr(buyecanrec)->Name(EcansPage::__selector1_);
    ::g::Fuse::Controls::DockPanel::SetDock(buyecanrec, 3);
    ::g::Fuse::Gestures::Clicked::AddHandler(buyecanrec, uDelegate::New(::TYPES[2/*Fuse.Gestures.ClickedHandler*/], (void*)::g::Fuse::Reactive::EventBinding__OnEvent_fn, uPtr(temp_eb33)));
    ::g::Uno::Collections::ICollection::Add_ex(uInterface(uPtr(uPtr(buyecanrec)->Children()), ::TYPES[1/*Uno.Collections.ICollection<Fuse.Node>*/]), temp45);
    ::g::Uno::Collections::ICollection::Add_ex(uInterface(uPtr(uPtr(buyecanrec)->Children()), ::TYPES[1/*Uno.Collections.ICollection<Fuse.Node>*/]), temp46);
    ::g::Uno::Collections::ICollection::Add_ex(uInterface(uPtr(uPtr(buyecanrec)->Bindings()), ::TYPES[3/*Uno.Collections.ICollection<Fuse.Binding>*/]), temp_eb33);
    temp45->Value(::STRINGS[18/*"BUY ECAN"*/]);
    temp45->Alignment(14);
