// This file was generated based on '.uno/ux11/Mouse.g.uno'.
...
// {
// static Mouse() :4
static void Mouse__cctor_4_fn(uType* __type)
{
}

static void Mouse_build(uType* type)
{
    type->SetInterfaces(
...
::g::Fuse::Controls::TextControl_type* Mouse_typeof()
{
    ...
    options.ObjectSize = sizeof(Mouse);
    options.TypeSize = sizeof(::g::Fuse::Controls::TextControl_type);
    type = (::g::Fuse::Controls::TextControl_type*)uClassType::New("Mouse", options);
    type->fp_build_ = Mouse_build;
    type->fp_ctor_ = (void*)Mouse__New4_fn;
    type->fp_cctor_ = Mouse__cctor_4_fn;
...
void Mouse::InitializeUX1()
{
    FontSize(18.0f);
    Color(::g::Uno::Float4__New2(1.0f, 1.0f, 1.0f, 1.0f));
    Font(::g::PaymentPage::Mouse());
}

// public Mouse New() [static] :8
Mouse* Mouse::New4()
{
    Mouse* obj1 = (Mouse*)uNew(Mouse_typeof());
    obj1->ctor_8();
    return obj1;
}
// }
