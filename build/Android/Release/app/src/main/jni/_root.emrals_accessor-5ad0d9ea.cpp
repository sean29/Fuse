...
// {
// static emrals_accessor_MyLoadingIndicator_ThemeColor() :1
...
static void emrals_accessor_MyLoadingIndicator_ThemeColor_build(uType* type)
{
    ...
    type->SetFields(0,
        ::g::Uno::UX::Selector_typeof(), (uintptr_t)&::g::emrals_accessor_MyLoadingIndicator_ThemeColor::_name_, uFieldFlagsStatic,
        ::g::Uno::UX::PropertyAccessor_typeof(), (uintptr_t)&::g::emrals_accessor_MyLoadingIndicator_ThemeColor::Singleton_, uFieldFlagsStatic);
}
...
{
    return *__retval = emrals_accessor_MyLoadingIndicator_ThemeColor::_name(), void();
}
