...
namespace g{struct emrals_MyLoadingIndicator_ThemeColor_Property;}
...
struct emrals_MyLoadingIndicator_ThemeColor_Property : ::g::Uno::UX::Property1
{
    uWeak< ::g::MyLoadingIndicator*> _obj;

    void ctor_3(::g::MyLoadingIndicator* obj, ::g::Uno::UX::Selector name);
    static emrals_MyLoadingIndicator_ThemeColor_Property* New1(::g::MyLoadingIndicator* obj, ::g::Uno::UX::Selector name);
};
// }
