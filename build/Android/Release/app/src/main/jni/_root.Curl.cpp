// This file was generated based on '.uno/ux13/Curl.g.uno'.
...
// public partial sealed class Curl :2
// {
// static Curl() :4
static void Curl__cctor_4_fn(uType* __type)
{
}

static void Curl_build(uType* type)
{
    type->SetInterfaces(
...
::g::Fuse::Controls::TextControl_type* Curl_typeof()
{
    ...
    options.ObjectSize = sizeof(Curl);
    options.TypeSize = sizeof(::g::Fuse::Controls::TextControl_type);
    type = (::g::Fuse::Controls::TextControl_type*)uClassType::New("Curl", options);
    type->fp_build_ = Curl_build;
    type->fp_ctor_ = (void*)Curl__New4_fn;
    type->fp_cctor_ = Curl__cctor_4_fn;
...
// public Curl() :8
void Curl__ctor_8_fn(Curl* __this)
{
    __this->ctor_8();
}

// private void InitializeUX() :12
void Curl__InitializeUX1_fn(Curl* __this)
{
    __this->InitializeUX1();
}

// public Curl New() :8
void Curl__New4_fn(Curl** __retval)
{
    *__retval = Curl::New4();
}

// public Curl() [instance] :8
void Curl::ctor_8()
{
    ctor_7();
    InitializeUX1();
...
void Curl::InitializeUX1()
{
    FontSize(20.0f);
    Color(::g::Uno::Float4__New2(0.3882353f, 0.3882353f, 0.3921569f, 1.0f));
    Font(::g::ImpactPage::Curl());
}

// public Curl New() [static] :8
Curl* Curl::New4()
{
    Curl* obj1 = (Curl*)uNew(Curl_typeof());
    obj1->ctor_8();
    return obj1;
}
// }
