...
struct emrals_accessor_MyLoadingIndicator_ThemeColor : ::g::Uno::UX::PropertyAccessor
{
    ...
    static ::g::Uno::UX::Selector& _name() { return emrals_accessor_MyLoadingIndicator_ThemeColor_typeof()->Init(), _name_; }
    static uSStrong< ::g::Uno::UX::PropertyAccessor*> Singleton_;
    static uSStrong< ::g::Uno::UX::PropertyAccessor*>& Singleton() { return emrals_accessor_MyLoadingIndicator_ThemeColor_typeof()->Init(), Singleton_; }
