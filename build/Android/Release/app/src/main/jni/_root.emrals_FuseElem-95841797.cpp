...
static void emrals_FuseElementsElement_Visibility_Property_build(uType* type)
{
    ...
    type->SetFields(1,
        ::TYPES[0/*Fuse.Elements.Element*/], offsetof(emrals_FuseElementsElement_Visibility_Property, _obj), uFieldFlagsWeak);
}
...
// public emrals_FuseElementsElement_Visibility_Property(Fuse.Elements.Element obj, Uno.UX.Selector name) :136
...
// public override sealed Fuse.Elements.Visibility Get(Uno.UX.PropertyObject obj) :138
...
// public emrals_FuseElementsElement_Visibility_Property New(Fuse.Elements.Element obj, Uno.UX.Selector name) :136
...
// public override sealed void Set(Uno.UX.PropertyObject obj, Fuse.Elements.Visibility v, Uno.UX.IPropertyListener origin) :139
...
// public emrals_FuseElementsElement_Visibility_Property(Fuse.Elements.Element obj, Uno.UX.Selector name) [instance] :136
...
// public emrals_FuseElementsElement_Visibility_Property New(Fuse.Elements.Element obj, Uno.UX.Selector name) [static] :136
