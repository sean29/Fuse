// This file was generated based on '.uno/ux13/Horse.g.uno'.
...
// {
// static Horse() :4
static void Horse__cctor_4_fn(uType* __type)
{
}

static void Horse_build(uType* type)
{
    type->SetInterfaces(
...
::g::Fuse::Controls::TextControl_type* Horse_typeof()
{
    ...
    options.ObjectSize = sizeof(Horse);
    options.TypeSize = sizeof(::g::Fuse::Controls::TextControl_type);
    type = (::g::Fuse::Controls::TextControl_type*)uClassType::New("Horse", options);
    type->fp_build_ = Horse_build;
    type->fp_ctor_ = (void*)Horse__New4_fn;
    type->fp_cctor_ = Horse__cctor_4_fn;
...
void Horse::InitializeUX1()
{
    FontSize(20.0f);
    Color(::g::Uno::Float4__New2(1.0f, 1.0f, 1.0f, 1.0f));
    Font(::g::MainView::Horse());
}

// public Horse New() [static] :8
Horse* Horse::New4()
{
    Horse* obj1 = (Horse*)uNew(Horse_typeof());
    obj1->ctor_8();
    return obj1;
}
// }
