// This file was generated based on '.uno/ux11/PTBold.g.uno'.
...
// public partial sealed class PTBold :2
// {
// static PTBold() :4
static void PTBold__cctor_4_fn(uType* __type)
{
}

static void PTBold_build(uType* type)
{
    type->SetInterfaces(
...
::g::Fuse::Controls::TextControl_type* PTBold_typeof()
{
    ...
    options.ObjectSize = sizeof(PTBold);
    options.TypeSize = sizeof(::g::Fuse::Controls::TextControl_type);
    type = (::g::Fuse::Controls::TextControl_type*)uClassType::New("PTBold", options);
    type->fp_build_ = PTBold_build;
    type->fp_ctor_ = (void*)PTBold__New4_fn;
    type->fp_cctor_ = PTBold__cctor_4_fn;
...
// public PTBold() :8
void PTBold__ctor_8_fn(PTBold* __this)
{
    __this->ctor_8();
}

// private void InitializeUX() :12
void PTBold__InitializeUX1_fn(PTBold* __this)
{
    __this->InitializeUX1();
}

// public PTBold New() :8
void PTBold__New4_fn(PTBold** __retval)
{
    *__retval = PTBold::New4();
}

// public PTBold() [instance] :8
void PTBold::ctor_8()
{
    ctor_7();
    InitializeUX1();
...
void PTBold::InitializeUX1()
{
    FontSize(22.0f);
    Color(::g::Uno::Float4__New2(0.2235294f, 0.2235294f, 0.2235294f, 1.0f));
    Font(::g::CameraPage::PTBold());
}

// public PTBold New() [static] :8
PTBold* PTBold::New4()
{
    PTBold* obj1 = (PTBold*)uNew(PTBold_typeof());
    obj1->ctor_8();
    return obj1;
}
// }
